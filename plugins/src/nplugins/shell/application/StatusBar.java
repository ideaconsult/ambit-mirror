...
public class StatusBar extends JPanel implements PropertyChangeListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5083099718858815060L;
	...
	setBorder(new EmptyBorder(2, 0, 4, 0)); // top, left, bottom, right
	...
	busyIcon = Utils.createImageIcon("nplugins/shell/resources/busyicons/wait18trans.gif");
    ...
    public void showBusyAnimation() {
    	statusAnimationLabel.setIcon(busyIcon);
    }
