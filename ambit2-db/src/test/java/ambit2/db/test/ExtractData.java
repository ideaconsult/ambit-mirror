...
public class ExtractData {
    ...
    protected static void extract() throws Exception {
        ...
        Connection jdbcConnection = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/ambit2", "guest", "guest");
        ...
        partialDataSet.addTable("tuples",String.format("select * from tuples where idtuple in (select idtuple from property_tuples join property_values using(id) join structure using(idstructure) where idchemical in %s)",ids)); 
