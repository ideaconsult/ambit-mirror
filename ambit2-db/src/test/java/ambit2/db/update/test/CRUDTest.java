...
public abstract class CRUDTest<G, T> extends DbUnitTest {
	...
	protected String dbFile = "ambit2/db/processors/test/descriptors-datasets.xml";
	...
	protected abstract void createVerify(IQueryUpdate<G, T> query)
			throws Exception;

	protected abstract void createVerifyNew(IQueryUpdate<G, T> query)
			throws Exception;

	protected abstract void updateVerify(IQueryUpdate<G, T> query)
			throws Exception;

	protected abstract void deleteVerify(IQueryUpdate<G, T> query)
			throws Exception;
}
