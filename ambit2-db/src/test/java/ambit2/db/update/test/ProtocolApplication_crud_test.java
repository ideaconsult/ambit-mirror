...
public class ProtocolApplication_crud_test extends CRUDTest<String,ProtocolApplication<Protocol, Params, String, Params, String>> {
	...
	protected void updateVerify(IQueryUpdate<String,ProtocolApplication<Protocol, Params, String, Params, String>> query)
		...
		"SELECT document_prefix,hex(document_uuid) u,endpointcategory,endpoint,guidance,substance_prefix,hex(substance_uuid) su,params,reference from substance_protocolapplication where document_prefix='IUC4' and hex(document_UUID)='7ADB0D03F69B32A99EFE86B4A8577893'");
