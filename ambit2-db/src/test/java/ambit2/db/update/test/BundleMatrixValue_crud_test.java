 ...
 * 
 */
public class BundleMatrixValue_crud_test extends
		CRUDTest<SubstanceEndpointsBundle, ValueAnnotated> {
	@Override
	...
	@Override
	protected IQueryUpdate<SubstanceEndpointsBundle, ValueAnnotated> createQuery()
			throws Exception {
		return null;
	}

	@Override
	protected IQueryUpdate<SubstanceEndpointsBundle, ValueAnnotated> createQueryNew()
			throws Exception {
		return null;
	}

	@Override
	protected IQueryUpdate<SubstanceEndpointsBundle, ValueAnnotated> updateQuery()
			throws Exception {
		return null;
	}

	@Override
	protected IQueryUpdate<SubstanceEndpointsBundle, ValueAnnotated> deleteQuery()
			throws Exception {
	...
	protected void createVerify(
			IQueryUpdate<SubstanceEndpointsBundle, ValueAnnotated> query)
			throws Exception {
	}
