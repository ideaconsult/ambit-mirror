 ...
 *
 */
public class QueryStudyResults extends QueryExperiment<String,StringCondition> {
	public String getSQL() throws AmbitException {
		...
		sql.append("join\n");
		sql.append("(select idexperiment,id_fieldname,value from study_results join study_fieldnames using(id_fieldname) where name=? and value ");
