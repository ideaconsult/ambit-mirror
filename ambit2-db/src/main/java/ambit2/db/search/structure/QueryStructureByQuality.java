...
public class QueryStructureByQuality extends AbstractStructureQuery<IStructureRecord, QLabel, StringCondition> {
	...
	public final static String sql = 
		"select ? as idquery,idchemical,idstructure,if(type_structure='NA',0,1) as selected,cast(quality_structure.label as unsigned) as metric,quality_structure.label from structure left join quality_structure using(idstructure) ";
