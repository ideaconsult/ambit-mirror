...
public class QueryFieldNumeric extends AbstractStructureQuery<Property,Number,NumberCondition> {
	...
	public final static String sqlField = 
		"SELECT ? as idquery,idchemical,idstructure,if(type_structure='NA',0,1) as selected,value_num as metric,null as text FROM properties join property_values using(idproperty) join structure using(idstructure) ";
