...
public class FingerprintsByStatus extends AbstractStructureQuery<FPTable, String, EQCondition> {
	...
	public final static String sql =
		"select idchemical from chemicals where idchemical not in (select idchemical from %s where status = ?)\n";
	...
	public String getSQL() throws AmbitException {
		return String.format(sql,getFieldname().getTable());
	}
