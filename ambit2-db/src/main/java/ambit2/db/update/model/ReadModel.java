 ...
 * 
 */
public class ReadModel extends AbstractModelQuery<String, Integer> implements
		IQueryRetrieval<ModelQueryResults> {
	...
	public String getSQL() throws AmbitException {
		...
		if (getFieldname() != null) {
			b.append(where);
			b.append(String.format(_models_criteria.name.getSQL(),
					getCondition()));
			where = " or ";
		}
		if (getValue() != null) {
	...
	public String toString() {
		return getValue() == null ? "All models" : String.format("Model id=%d",
				getValue());
	}
}
