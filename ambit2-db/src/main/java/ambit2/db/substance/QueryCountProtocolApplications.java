...
public class QueryCountProtocolApplications<F extends SubstanceByCategoryFacet>
	...
	public String getSQL() throws AmbitException {
		...
		default: {
			...
			return String
					.format(((bundle != null) && (bundle.getID() > 0)) ? sql_bundle_byendpoints
							: sql, b.toString());
		}
		}
	...
	protected F createFacet(String facetURL) {
		if (mode==null) return  (F) new SubstanceByCategoryFacet(facetURL);
		F facet;
		...
		case substances: {
			...
			if (getValue() != null)
				params.add(new QueryParam<String>(String.class, getValue()
						.toString()));
			if ((bundle != null) && (bundle.getID() > 0))
				params.add(new QueryParam<Integer>(Integer.class, getBundle()
						.getID()));
			else
				throw new AmbitException("bundle not defined");
			return params;
