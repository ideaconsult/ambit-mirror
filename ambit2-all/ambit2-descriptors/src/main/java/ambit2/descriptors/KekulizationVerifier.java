...
public class KekulizationVerifier implements IMolecularDescriptor {
	...
	public DescriptorValue calculate(IAtomContainer mol) {
		...
		try {
			...
			IMolecule kekuleMol = typer.fixAromaticBondOrders((IMolecule)mol);
	...
	public DescriptorSpecification getSpecification() {
        return new DescriptorSpecification(
            	String.format("http://www.opentox.org/algorithmTypes#%s","KekulizationVerifier"),
    		    this.getClass().getName(),
    		    "$Id: KekulizationVerifier.java,v 1.0 2010/08/05 8:12:00 Nina Jeliazkova Exp $",
