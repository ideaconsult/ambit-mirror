...
public class  EccentricBasedMadanIndicesDescriptor implements IMolecularDescriptor
{
	...
	public DescriptorValue calculate(IAtomContainer container)
	{
		...
		double CSI = 0.0; //this is the name by Dragon for Eccentric connectivity index
