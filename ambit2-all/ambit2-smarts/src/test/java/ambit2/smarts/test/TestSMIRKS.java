...
public class TestSMIRKS {
	...
	public void testSM0001() throws Exception {
		...
		// System.out.println("Reaction application: " + target + "  -->  " +
		// transformedSmiles);
	...
	public void testAromatic_hydroxylation() throws Exception {
		...
		IAtomContainer result = applySMIRKSReaction(smirks, target);
		Assert.assertNotNull(result);
		// In the current version aromaticity must be re-detected in the final
		// result
	...
	public void testAliphatic_hydroxylation() throws Exception {
		...
		// when H are implicit (actually 'semi-implicit') only one location is
		// matched
	...
	public void testAldehyde_oxidation_extraH() throws Exception {
		...
		String expectedResultExplH[] = new String[] { "[H]C([H])([H])C([H])([H])C([H])([H])C([H])([H])C(=O)C(=O)O" };
	...
	public void testAldehyde_oxidation() throws Exception {
		...
		String expectedResultExplH[] = new String[] { "C([H])([H])([H])C([H])([H])N(C([H])([H])C([H])([H])([H]))C([H])(=O)O" };
