...
ALTER TABLE `property_annotation` CHANGE COLUMN `object` `object` VARCHAR(255) CHARACTER SET 'utf8' NOT NULL COMMENT 'object'  
		, DROP INDEX `Index_2`  , ADD INDEX `Index_2` USING BTREE (`predicate` ASC, `object` ASC) ;
