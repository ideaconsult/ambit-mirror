...
prefix as s_prefix,hex(uuid) as s_uuid,substanceType,reference_year,content,if(investigation_uuid is null,null,hex(investigation_uuid)) as iuuid,if(assay_uuid is null,null,hex(assay_uuid)) as auuid ,updated,
