...
prefix as s_prefix,hex(uuid) as s_uuid,substanceType,reference_year,content,hex(investigation_uuid) investigation ,updated,
reliability,purposeFlag,studyResultType,isRobustStudy,isUsedforClassification,isUsedforMSDS,resulttype
FROM substance
...
where p.topcategory=:_topcategory and p.endpointcategory=:_endpointcategory and
(substance.name regexp :_name1 or substance.publicname regexp :_name2)