...
public class CreateUser extends AbstractObjectUpdate<AmbitUser> {
	...
	public static final String insert_roles = "insert ignore into roles (role_name) values (?)";
	public static final String insert_user = "insert into users (user_name,password,email,firstname,lastname,registration_date,registration_status,webpage) values (?,MD5(?),?,?,?,now(),\"confirmed\",?) ON DUPLICATE KEY UPDATE password=MD5(?)";
	public static final String insert_userroles = "insert ignore into user_roles (user_name,role_name) values (?,?)";
