 ...
 * 
 */
public class QuickImportBatchProcessor extends
		BatchDBProcessor<IStructureRecord> {
	...
	public QuickImportBatchProcessor(File file, boolean readonly) {
		super();
		...
		processor
				.add(new DefaultAmbitProcessor<IStructureRecord, IStructureRecord>() {
					...
					// protected transient SMARTSPropertiesGenerator atomprops =
					// new SMARTSPropertiesGenerator();
					@Override
