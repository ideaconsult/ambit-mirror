 ...
 *
 */
public class ChemicalByAssessment extends AbstractStructureQuery<String[],Integer,StringCondition> {
	...
	public ChemicalByAssessment(String[] assessment) {
		super();
		setFieldname(assessment);
	}
