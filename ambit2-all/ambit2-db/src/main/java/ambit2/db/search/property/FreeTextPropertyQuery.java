...
public class FreeTextPropertyQuery extends AbstractPropertyRetrieval<String[], String[], StringCondition>{
	...
	protected static final String pairSQL = 
		"(select idproperty,name,units,title,url,idreference,comments,null,islocal  from catalog_references join properties using(idreference) join property_values using(idproperty)\n"+
	...
	protected static final String singleSQLName = 
		"(select idproperty,name,units,title,url,idreference,comments,null,islocal  from catalog_references join properties using(idreference)\n"+
