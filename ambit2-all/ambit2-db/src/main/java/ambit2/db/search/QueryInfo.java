...
public class QueryInfo extends Model {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4326235497693115555L;
	...
	public void setDataset(SourceDataset dataset) {
		...
		if (dataset == null) setScope(SCOPE_DATABASE);		
		else setScope(SCOPE_DATASET);
	}
	...
	public void setStoredQuery(IStoredQuery storedQuery) {
		...
		if (storedQuery == null) setScope(SCOPE_DATABASE);
		else setScope(SCOPE_QUERY);		
	}
