...
public class UpdateSubstanceStudyBundle extends UpdateSubstanceStudy {
	...
	private static final String[] create_sql_bundle = {
		...
		"isUsedforClassification=values(isUsedforClassification),purposeFlag=values(purposeFlag),studyResultType=values(studyResultType),investigation_uuid=values(investigation_uuid),assay_uuid=values(assay_uuid)" 
	};
