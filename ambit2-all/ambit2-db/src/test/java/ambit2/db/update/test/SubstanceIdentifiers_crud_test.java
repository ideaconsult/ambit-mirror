...
public class SubstanceIdentifiers_crud_test extends
		CRUDTest<Object, SubstanceRecord> {
	...
	protected IQueryUpdate<Object, SubstanceRecord> createQuery()
		...
		if (c.getExternalids() == null)
			c.setExternalids(new ArrayList<ExternalIdentifier>());
	...
	protected void createVerify(IQueryUpdate<Object, SubstanceRecord> query)
	       ...
	       IDatabaseConnection c = getConnection();	
			...
			Assert.assertEquals(example_uuid,
					...
					table.getValue(0,"prefix"),table.getValue(0,"u")));
