...
public class BundleChemical_crud_test extends
		CRUDTest<SubstanceEndpointsBundle, IStructureRecord> {
	@Override
	...
	protected void createVerify(
		...
		Assert.assertEquals(StringUtils.repeat("A",50), table.getValue(0, "remarks"));
		c.close();
	}
