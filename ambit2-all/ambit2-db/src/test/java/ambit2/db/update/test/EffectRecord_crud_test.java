...
public class EffectRecord_crud_test
		extends
		CRUDTest<ProtocolApplication<Protocol, Params, String, Params, String>, EffectRecord> {
	...
	protected IQueryUpdate<ProtocolApplication<Protocol, Params, String, Params, String>, EffectRecord> updateQuery()
		...
		return new UpdateEffectRecords(
				"IUC4-efdb21bb-e79f-3286-a988-b6f6944d3734", papp, effect);

	}

	@Override
	protected void updateVerify(
			IQueryUpdate<ProtocolApplication<Protocol, Params, String, Params, String>, EffectRecord> query)
			throws Exception {
		...
		Assert.assertEquals(effect.getConditions().toString(),
				table.getValue(0, "conditions"));
		Assert.assertEquals(effect.getUnit(), table.getValue(0, "unit"));
		Assert.assertEquals(effect.getLoQualifier(),
				table.getValue(0, "loQualifier"));
		Assert.assertEquals(effect.getUpQualifier(),
				table.getValue(0, "upQualifier"));
	...
	@Override
	protected IQueryUpdate<ProtocolApplication<Protocol, Params, String, Params, String>, EffectRecord> createQuery()
			throws Exception {
		Protocol p = new Protocol("test");
		p.setCategory("PC_PARTITION_SECTION");
		p.setTopCategory("P-CHEM");
		...
		return new UpdateEffectRecords(
				"IUC4-efdb21bb-e79f-3286-a988-b6f6944d3734", papp,
				initeffect_PC_PARTITION_SECTION());
	}
	...
	protected IQueryUpdate<ProtocolApplication<Protocol, Params, String, Params, String>, EffectRecord> createQueryNew()
			throws Exception {
		// return new
		// UpdateEffectRecords("IUC4-1d75f01c-3b2b-35f5-84f1-ce23e22b6c73",
		// initeffect_TO_BIODEG_WATER_SCREEN_SECTION());
		Protocol p = new Protocol("test");
	...
	@Override
	protected IQueryUpdate<ProtocolApplication<Protocol, Params, String, Params, String>, EffectRecord> deleteQuery()
			throws Exception {
		Protocol p = new Protocol("test");
		ProtocolApplication papp = new ProtocolApplication(p);
		papp.setDocumentUUID("IUC4-7adb0d03-f69b-32a9-9efe-86b4a8577893");
