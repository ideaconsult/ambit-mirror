...
into outfile "substance_table.tsv"
...
into outfile "substance_protocolapplication_table.tsv"
FIELDS TERMINATED BY '\t' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
into outfile "substance_experiment_table.tsv"
FIELDS TERMINATED BY '\t' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
into outfile "substance_ids_table.tsv"
FIELDS TERMINATED BY '\t' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
FROM substance_ids;
...
c.rs_prefix,hex(c.rs_uuid),c.name,
prefix,hex(uuid),
inchi,smiles,formula,inchikey,label,lastmodified
into outfile "substance_relation_chemicals_table.tsv"
FIELDS TERMINATED BY '\t' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
