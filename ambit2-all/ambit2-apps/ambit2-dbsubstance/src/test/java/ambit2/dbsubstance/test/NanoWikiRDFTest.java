...
public class NanoWikiRDFTest  extends DbUnitTest {
	...
	public void testRead() throws Exception {
		...
		int records = 0;
		try {
			reader = new NanoWikiRDFReader(new InputStreamReader(new FileInputStream(new File("D:/src-other/nanowiki/backup_public_v2.rdf")),"UTF-8"));
	...
	public void testWriteNanoWikiRDF() throws Exception {
        ...
        try {
	        parser = new NanoWikiRDFReader(new InputStreamReader(new FileInputStream(new File("D:/src-other/nanowiki/backup_public_v2.rdf")),"UTF-8"));
