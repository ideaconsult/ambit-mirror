<ul id="menu_substance">
	...
	<li ><a href="${ambit_root}/substance?page=0&pagesize=10" title="Nanomaterials">Nanomaterials</a></li>

	<li><a href="${ambit_root}/bundle" title="Browse/Edit">Nanomaterial Bundles</a></li>
