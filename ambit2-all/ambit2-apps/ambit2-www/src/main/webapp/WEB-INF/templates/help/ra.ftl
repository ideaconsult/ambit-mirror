...
<div id="keys" style="display:none;">
  <ul>
    <li><a href="#assessment">Assessment ID</a></li>
  ...
  <div id="a_source">
    The same as or assessment code field is a non-mandatory free text field, which allows the user to assign an own code to the assessment for easy retrieval, e.g. company specific code.
	<br>    
    The source URL or Assessment DocLink(s) field may contain an URL to relevant documents on the intranet or internet.  
