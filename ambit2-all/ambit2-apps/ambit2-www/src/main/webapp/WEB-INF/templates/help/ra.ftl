...
<li>Report<a href='#' class='chelp a_tab5'></a></li>
</ol>
</div>
...
<div id="keys" style="display:none;">
  ...
  <div id="a_code">
    This is a free text field, which allows the user to assign an own code to the assessment for easy retrieval, e.g. company specific code.
  </div>  
  <div id="a_doclink">    
	This is a free text field, where one or more references can be given to documents e.g. hyperlink of an assessment report stored in a document management system
  </div>    
  <div id="a_description">
    This is a free text field, where the user can describe the purpose of the assessment e.g. environmental assessment section.
  </div>    
  <div id="a_maintainer">
  ...
  <div id="a_status">
    Automatically assigned status. One of <i>draft</i>, <i>published</i>, <i>archived</i>. Old versions have  <i>archived</i> status.
  </div>
  <div id="a_started">
  ...
  <div id="a_published">
    Automatically assigned status. One of <i>draft</i>, <i>published</i>, <i>archived</i>. 
    New assessments are created as <i>drafts</i>. Old versions have <i>archived</i> status. The published status is assigned when clicking the <b>Finalize assessment</b> button.
  </div>
  ...
  <div id="a_tab4">
  	...
  	<li>The <b>final</b> matrix is the same as the working matrix, but with deleted entries hidden. Can not be edited.</li> 
  	</ul> 

  </div>      
  <div id="a_tab5">
	Assessment report. The report tab is enabled if the working matrix exists. 
	Click the "Create assessment report" link in order to view the an be viewed as HTML or downloaded as DOCX and Excel files.
	<ul>
	<li>Create assessment report</li>
	<li>Create Excel file with all used experimental data</li>
	<li>Create Excel file with the initial matrix</li>
	<li>Create Excel file with the working matrix</li>
	</ul>
   </div>        
