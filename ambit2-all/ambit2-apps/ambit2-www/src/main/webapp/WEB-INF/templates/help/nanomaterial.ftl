...
<div class='helpcontent'>
    The nanomaterials <a href='#' class='chelp nanomaterial'>?</a> are considered a special case of substances <a href='#' class='chelp substance'>?</a>. See <a href="http://www.beilstein-journals.org/bjnano/single/articleFullText.htm?publicId=2190-4286-6-165#O9" class='qxternal' target=guide>doi:10.3762/bjnano.6.165</a>.
    <br.>
        </br/>
</div>
...
<div id="keys" style="display:none;">
    <ul>
        <li><a href="#nanomaterial">Nanomaterial</a>
        </li>
        <li><a href="#substance">Chemical substance</a>
        </li>
        <li><a href="#main">Main constituent</a>
        </li>
        <li><a href="#additive">Additive</a>
        </li>
        <li><a href="#impurity">Impurity</a>
        </li>
        <li><a href="#i5z">.i5z file</a>
        </li>
        <li><a href="#substancesearch">Substance search</a>
        </li>
        ...
        <li><a href="#substancesearch">Search by name</a>
        </li>
        <li><a href="#nanomaterial2">Search by DOI</a>
        </li>
        <li><a href="#nanomaterial3">Nanomaterial</a>
        </li>
        <li><a href="#nanomaterial4">Search by composition</a>
        </li>
        <li><a href="#nanomaterial5">Free text search</a>
        </li>
        <li><a href="#nanomaterial6">Data model and upload</a>
        </li>
        <li><a href="#nanomaterial7">Application Programming Interface (API)</a>
        </li>
        <li><a href="#_oht">OECD HT</a>
        </li>
        <li><a href="#_nmdataparser">Custom spreadsheet</a>
        </li>
    </ul>
    ...
    <div id="nanomaterial6">
        Requires login!
        <br/> The data import is performed by HTTP POST to the substance resource, which translates to a regular web form for file upload.
    ...
    <div id="nanomaterial7">
        ...
        <br/> Representational state transfer (<a href="https://en.wikipedia.org/wiki/Representational_state_transfer" target='guide' class='qxternal'>REST</a>) is an abstraction of the architecture of the World Wide Web ;
        <br/>
    ...
    <div id="_nmdataparser">
        ...
        <ul>
            ...
            <li>Maps of the confidential spreadsheet templates are available on <a href='mailto:support@ideaconsult.net'>request</a>
            </li>
        </ul>
        <a href="http://www.beilstein-journals.org/bjnano/single/articleFullText.htm?publicId=2190-4286-6-165#F7" target='guide'>More</a>
    </div>
    <div id="nanomaterial">
        The Nano Particle Ontology (<a href='http://bioportal.bioontology.org/ontologies/NPO' target='bioportal'>NPO</a>) defines a nanomaterial (<a href='http://bioportal.bioontology.org/ontologies/ENM?p=classes&conceptid=http%3A%2F%2Fpurl.bioontology.org%2Fontology%2Fnpo%23NPO_199' target='bioportal'>NPO_199</a>) as equivalent to a chemical substance (<a href='http://bioportal.bioontology.org/ontologies/NPO?p=classes&conceptid=http%3A%2F%2Fpurl.bioontology.org%2Fontology%2Fnpo%23NPO_1973' target='bioportal'>NPO_1973</a>) that has as constituent a nano-object, nanoparticle, engineered nanomaterial, nanostructured material, or nanoparticle formulation. Chemical substances are classified as types of chemical entity (<a href='http://bioportal.bioontology.org/ontologies/NPO?p=classes&conceptid=http%3A%2F%2Fpurl.bioontology.org%2Fontology%2Fnpo%23NPO_1972' target='bioportal'>NPO_1972</a>).
    </div>
    <div id="substance">
	  ...
	  substances under REACH and CLP'>REACH guide</a>
        <ul>
            ...
            <li>Main constituent: a constituent, not being an additive or impurity, in a substance that makes up a significant part of that substance. Contributes to the naming of the substance.
            </li>
    ...
    <div id="i5z">
        <a href='http://en.wikipedia.org/wiki/IUCLID' class='qxternal' target=_blank>IUCLID 5</a> exports and imports files in the I5Z format. I5Z stands for "IUCLID 5 Zip", as the file uses Zip file compression.
        <br/> Only Substance (IUCLID 5.4, IUCLID 5.5) and ReferenceSubstance (IUCLID 5.0, IUCLID 5.4, IUCLID 5.5.) records (as defined by the <a href='http://iuclid.eu/index.php?fuseaction=home.format' class='qxternal' target=_blank>IUCLID schema</a>) can be imported in this version of Ambit.
    </div>
