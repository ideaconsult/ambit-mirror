...
public abstract class AmbitFacetResource<FACET extends IFacet<String>, Q extends IQueryRetrieval<FACET>> extends
	FacetResource<FACET, Q> {
	...
	if (variant.getMediaType().equals(MediaType.TEXT_CSV)) {
	    ...
	    return new OutputWriterConvertor(createJSONReporter(getRequest(), jsonpcallback),
		    MediaType.APPLICATION_JSON, filenamePrefix);
	} else if (variant.getMediaType().equals(MediaType.APPLICATION_JSON)) {
	    return new OutputWriterConvertor(createJSONReporter(getRequest(), null), MediaType.APPLICATION_JSON,
		    filenamePrefix);
