...
/**
 * A histogram. Used in {@link ambit2.domain.structure.DataCoverageAtomEnvironmentCore}
 * @author Nina Jeliazkova <br>
 * <b>Modified</b> 2005-6-20
 */
public class Histogram<T extends Comparable> extends TreeMap<T,MutableInt>{

    static Logger logger = Logger.getLogger(Histogram.class.getName());
    ...
    public double hellinger(Histogram hist) throws Exception {
        ...
        int cp = hist.count();
        if (cp == 0) { 
            logger.fine("The histogram to compare with is empty!");
