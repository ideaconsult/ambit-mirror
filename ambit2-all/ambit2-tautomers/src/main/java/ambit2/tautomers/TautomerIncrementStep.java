...
public class TautomerIncrementStep 
{
	...
	public List<RuleInstance> usedRuleInstances = new ArrayList<RuleInstance>();
	public List<RuleInstance> unUsedRuleInstances = new ArrayList<RuleInstance>();
