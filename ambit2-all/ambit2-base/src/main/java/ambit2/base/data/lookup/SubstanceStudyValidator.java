...
public class SubstanceStudyValidator extends  StructureRecordValidator {
	/**
	 * 
	 */
	private static final long serialVersionUID = -618986496159851967L;
	...
	public SubstanceStudyValidator(DictionaryConfig dict, String filename, boolean fixErrors, String prefix) {
		super(filename,fixErrors,prefix);
		if (dict == null)
	...
	public static void setUnitsUndefined(Properties unitsUndefined) {
		SubstanceStudyValidator.unitsUndefined = unitsUndefined;
	}
	...
	public static void seteUndefined(Properties eUndefined) {
		SubstanceStudyValidator.eUndefined = eUndefined;
	}
	...
	public static void setvUndefined(Properties vUndefined) {
		SubstanceStudyValidator.vUndefined = vUndefined;
	}
	...
	public static void setcUndefined(Properties cUndefined) {
		SubstanceStudyValidator.cUndefined = cUndefined;
	}
		...
		if (srecord.getMeasurements() != null) {
			...
			for (ProtocolApplication<Protocol, IParams, String, IParams, String>  papp : m) {
				try {
					...
					papp.getParameters().put("__input_file", getFilename());
				} catch (Exception x) {
					x.printStackTrace();
				}
