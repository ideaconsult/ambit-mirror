...
public class OTDatasetScrollableReport extends OTDatasetReport {
	...
	protected OTDatasetScrollableReport(OTDataset dataset,String application, int page, int pageSize) throws Exception {
		super(dataset,application,page,pageSize);
	}
	public static OTDatasetScrollableReport report(OTDataset dataset, String application, int page, int pageSize) throws Exception {
		return new OTDatasetScrollableReport(dataset,application,page,pageSize);
	}
	@Override
	...
	public void writeRow(int row, List<String> values, Writer writer)
		...
		writer.write(String.format(
				"%s.&nbsp;<img src='%s?w=240&h=200&media=image/png' alt='%s'>",
				row+page*pageSize,
