...
public class FreeMarkerStatusService extends StatusService implements
	...
	protected Representation getHTMLByTemplate(Status status, String errName,
			String errDescription, String details, Request request)
			throws ResourceException {

		Map<String, Object> map = new HashMap<String, Object>();
		if (request.getClientInfo().getUser() != null)
			map.put("username", request.getClientInfo().getUser()
					.getIdentifier());
	...
	protected Representation toRepresentation(Map<String, Object> map,
		...
		return new TemplateRepresentation(templateName, app.getConfiguration(),
