...
public class OTProcessingResource extends OTObject {
	...
	protected OTProcessingResource tasksCompleted(OTRemoteTaskPool pool) throws Exception {
	...
	protected OTDatasets taskResults(OTRemoteTaskPool pool, OTDatasets datasets) throws Exception {
