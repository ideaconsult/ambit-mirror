 ...
 * 
 * @author nina
 * Implementation of OpenTox API {@link http://opentox.org/dev/apis/api-1.1/Feature}
 */
@Deprecated
public class OTFeature extends OTProcessingResource  {
	...
	public void setUnits(String units) {
	 ...
	 public OTFeature(Reference ref) {
			super(ref);
		 }
	public OTFeature(String ref) {
		super(ref);
	}
	 ...
	 public OTFeature algorithm() throws Exception  { 
		 if (algorithm ==null) {
	        ...
	        try {
	        	...
	        	model = (OntModel)OT.createModel(model, getUri(),MediaType.APPLICATION_RDF_XML);	
	...
	public OTObject create() throws Exception {
	 ...
	 public OTFeature getPage(int page,int pageSize) throws Exception {
		 return feature(OTObject.getPagedReference(getUri(),page, pageSize));
	 }
	 
	 public OTFeature setSameas(String newLabel) throws Exception {
		 Model	jenaModel = ModelFactory
						.createDefaultModel();
		...
		jenaModel = OT.createModel(jenaModel, getUri(), MediaType.APPLICATION_RDF_XML);
	    ...
	    public boolean equals(Object obj) {
	    	if (obj instanceof OTFeature)
	    		return ((OTFeature)obj).getUri().toString().equals(getUri().toString());
	    	else return false;
	    }
	    public int hashCode() {
	    	int hash = 7;
