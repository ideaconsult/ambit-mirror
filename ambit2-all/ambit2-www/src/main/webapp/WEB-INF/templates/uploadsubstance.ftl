...
<div class="row remove-bottom">
		...
		<div class="alpha">
		    ...
		    <div class='h6'>Upload substances as defined in IUCLID 5 .i5d or .i5z files</div>
		</div>
		</div>
</div>		
<div class="row remove-bottom" >
...
<div class='ui-widget-content ui-corner-bottom'>	
	...
	<div class='row remove-bottom'>
		...
		<input class='eight columns alpha half-bottom'  type="file" name="file" title='Add new substance(s) (.i5d or .i5z file)' size="60">
