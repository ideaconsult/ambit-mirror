...
$(document).ready(function() {
	var oTable = loadMetadata("${ambit_root}","${ambit_request_json}");
...
<div class='row half-bottom chelp' style='padding:0;margin:0;' id='keycontent'>		
		...
		<form id='metatdata'>
		<label>Dataset URI</label><span id='uri'></span>
		<label>Number of structures</label><span id='numstructures'></span>
		<label>Dataset name</label><input id='title'  size='60'></input>
		<label>License/Rights</label><input id='license'></input>


Rights holder	

Source	excretion.sdf
See also	http://www.qsarworld.com/qsar-datasets-excretion.php
