<ul>
<li ><a href="${ambit_root}/dataset?page=0&pagesize=100" title="Datasets: Chemical structures and properties">All datasets</a>
<li ><a href="${ambit_root}/query/ndatasets_endpoint?feature_sameas=http%3A%2F%2Fwww.opentox.org%2FechaEndpoints.owl&condition=startswith" title="Datasets by endpoints">Datasets by endpoints</a>
