...
<div class='ui-widget-content ui-corner-bottom'>	
	...
	<div style="margin:5px;padding:5px;">
		...
		Please use the <a href='${ambit_root}/query/relation/has_tautomer/dataset?dataset_uri=&media=application/json'>${ambit_root}/query/relation/has_tautomer/dataset?dataset_uri=${ambit_root}/dataset/999</a> page to retrieve pre-generated tautomers.
		<br/>
	 	<h5>Tautomers per compound</h5>
		Please use the <a href='${ambit_root}/query/relation/has_tautomer/compound?dataset_uri=&media=application/json'>${ambit_root}/query/relation/has_tautomer/compound?dataset_uri=${ambit_root}/compound/999</a> page to retrieve pre-generated tautomers of all compounds in a dataset.
