...
package ambit2.applications.qmrf;
...
import ambit2.data.qmrf.QMRFData;
import ambit2.data.qmrf.QMRFGUITools;
import ambit2.data.qmrf.QMRFPanel;
...
usage: QMRFEditor
 -d,--dtd <url>          DTD schema location - URL where DTD schema
                         ...
                         -dhttp://ambit2.acad.bg/qmrf/qmrf.dtd)
...
public class QMRFEditor extends CoreApp implements Observer {
	...
	public QMRFEditor(String title, int w , int h,String[] args) {
		...
		Package adPackage = Package.getPackage("ambit2.data.qmrf");
