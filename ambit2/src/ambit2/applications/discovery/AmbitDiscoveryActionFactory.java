...
/**
 * An {@link ambit2.ui.actions.ActionFactory} descendant to create specific {@link javax.swing.Action}s for {@link ambit2.applications.discovery.AmbitDiscoveryApp}
...
public class AmbitDiscoveryActionFactory extends ActionFactory {
    ...
    public static AmbitAction createFileOpenAction(Object userData, JFrame mainFrame) {
    	return new ambit2.applications.discovery.FileOpenAction(userData,mainFrame,true);
    }
