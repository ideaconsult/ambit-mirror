 ...
 * 
 */
package ambit2.applications.dbadmin;
...
import ambit2.database.aquire.AquireRetrieveAction;
import ambit2.database.data.AmbitDatabaseToolsData;
import ambit2.database.data.DefaultSharedDbData;
import ambit2.exceptions.AmbitException;
import ambit2.ui.AboutAction;
import ambit2.ui.AmbitStatusBar;
import ambit2.ui.CoreApp;
import ambit2.ui.DBTaskPane;
import ambit2.ui.ObjectsPane;
import ambit2.ui.UITools;
import ambit2.ui.actions.ActionFactory;
import ambit2.ui.actions.process.Builder3DAction;
import ambit2.ui.actions.process.DescriptorCalculatorAction;
import ambit2.ui.actions.process.MetaboliteAction;
import ambit2.ui.actions.process.MoleculeEditAction;
import ambit2.ui.actions.process.MoleculeMOPACAction;
import ambit2.ui.actions.process.RetrieveDataAction;
import ambit2.ui.actions.process.ToxTreeAction;
...
import ambit2.ui.actions.search.DbSaveAsDataset;
import ambit2.ui.actions.search.ExperimentsByStudyAction;
import ambit2.ui.data.molecule.CompoundsPanel;
import ambit2.ui.data.molecule.SmilesEntryPanel;
import ambit2.ui.data.molecule.AmbitDetailsPanel;
...
delete from src_dataset where id_srcdataset=7; 
	...
	protected JMenuBar createMenuBar() {
		...
		*/
		...
		menu = new JMenu("Help");
		menuBar.add(menu);
		ambit2.ui.actions.HelpAction helpAction = new ambit2.ui.actions.HelpAction("AMBIT Database Tools HELP",mainFrame);
		menu.add(helpAction);
		
		
		AboutAction aboutAction = new AboutAction("Ambit Database Tools",mainFrame);
		aboutAction.setIconFile("ambit2/ui/images/ambit_logo.jpg");
	...
	protected void createWidgets(JFrame aFrame, JPanel aPanel) {
        ...
        Object[] keys;
        ImageIcon database = UITools.createImageIcon("/ambit2/ui/images/dbIcon.jpg");
        JPanel taskPanel= new DBTaskPane(new Object[][] {
        		{calculationActions,"Molecule",UITools.createImageIcon("/ambit2/ui/images/benzene_16.jpg")},
		...
		DbExactSearchAction drawSmilesAction = new DbExactSearchAction(dbadminData,mainFrame,"Exact search",UITools.createImageIcon("ambit2/ui/images/draw_16.png")){
