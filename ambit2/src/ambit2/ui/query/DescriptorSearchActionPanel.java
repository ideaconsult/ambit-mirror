...
import ambit2.database.query.IDBQueryList;
import ambit2.ui.AmbitColors;
import ambit2.ui.data.molecule.ActionPanel;
...
public class DescriptorSearchActionPanel extends ActionPanel implements ActionListener{
    ...
    /* (non-Javadoc)
     * @see ambit2.toolbox.ActionPanel#addWidgets()
     */
    ...
    /* (non-Javadoc)
     * @see ambit2.toolbox.ActionPanel#getResultComponent()
     */
