...
import ambit2.ui.data.experiment.StudyListModel;

/**
 * USer interface to specify query by experimental data. See example for {@link ambit2.database.data.AmbitDatabaseToolsData}.
