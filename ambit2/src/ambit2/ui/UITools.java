...
import ambit2.ui.actions.InsertSymbolAction;
...
public class UITools {
	...
	public static JMenu createEditMenu(Container mainFrame) {
		...
		menuItem.setIcon(UITools.createImageIcon("ambit2/ui/images/cut.png"));
		...
		menuItem.setIcon(UITools.createImageIcon("ambit2/ui/images/paste_plain.png"));
		...
		menuItem.setIcon(UITools.createImageIcon("ambit2/ui/images/text_letter_omega.png"));
	...
	public static JMenu createStyleMenu() {
        ...
        action.putValue(Action.SMALL_ICON, UITools.createImageIcon("ambit2/ui/images/text_bold.png"));
        action.putValue(Action.NAME, "Bold");
        menu.add(new JCheckBoxMenuItem(action));

        action = new StyledEditorKit.ItalicAction();
        action.putValue(Action.SMALL_ICON, UITools.createImageIcon("ambit2/ui/images/text_italic.png"));
        action.putValue(Action.NAME, "Italic");
        menu.add(new JCheckBoxMenuItem(action));

        action = new StyledEditorKit.UnderlineAction();
        action.putValue(Action.SMALL_ICON, UITools.createImageIcon("ambit2/ui/images/text_underline.png"));
        ...
        g = new ButtonGroup();
        ImageIcon f = UITools.createImageIcon("ambit2/ui/images/style.png");
...
class SubscriptAction extends StyledEditorKit.StyledTextAction{			
	public SubscriptAction(){			
		...
		putValue(Action.SMALL_ICON, UITools.createImageIcon("ambit2/ui/images/text_subscript.png"));
	}		
...
class NormalScriptAction extends StyledEditorKit.StyledTextAction{			
	public NormalScriptAction(){			
		...
		putValue(Action.SMALL_ICON, UITools.createImageIcon("ambit2/ui/images/font.png"));
...
class SuperscriptAction extends StyledEditorKit.StyledTextAction{			
	public SuperscriptAction(){			
		...
		putValue(Action.SMALL_ICON, UITools.createImageIcon("ambit2/ui/images/text_superscript.png"));
	}		
	public void actionPerformed(ActionEvent ae){			
		JEditorPane editor = getEditor(ae);			
		if (editor != null) {				
