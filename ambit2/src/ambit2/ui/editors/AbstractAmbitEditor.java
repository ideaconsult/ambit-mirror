...
public abstract class AbstractAmbitEditor extends JPanel implements IAmbitEditor, TableCellRenderer, TableModelListener{
    ...
    protected AmbitInterface object;
     ...
     * 
     */
    public AbstractAmbitEditor(String caption, AmbitInterface object) {
        super();
	...
	protected JScrollPane createEditorForMap(Map hashtable) {
		MapTableModel hashtableModel = new MapTableModel(hashtable) {
