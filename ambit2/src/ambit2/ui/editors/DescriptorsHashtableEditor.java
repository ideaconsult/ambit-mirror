...
/**
 * Visualization of {@link ambit2.data.descriptors.DescriptorsHashtable}
...
public class DescriptorsHashtableEditor implements IAmbitEditor {
	...
	/**
     * Creates a read-only JTable within a JScrollPane, containing {@link ambit2.data.descriptors.DescriptorsHashtable}.
    ...
    /**
     * Creates a JTable within a JScrollPane, containing {@link ambit2.data.descriptors.DescriptorsHashtable}.
     * Three columns - selected, descriptor name, remark  
