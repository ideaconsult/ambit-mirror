...
import ambit2.data.IAmbitSearchable;
import ambit2.data.qmrf.AmbitListTableModelNew;
	...
	public JComponent createSearchPanel() {
		if (list instanceof IAmbitSearchable) {
			...
			final AbstractAction search = new AbstractActionWithTooltip("Find",
					UITools.createImageIcon("ambit2/ui/images/search.png"),"Search within this catalog") {
