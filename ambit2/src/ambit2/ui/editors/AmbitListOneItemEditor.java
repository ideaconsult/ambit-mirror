...
public class AmbitListOneItemEditor extends AbstractAmbitListEditor implements IAmbitEditor {
	...
	public JToolBar createJToolbar() {
		...
		AbstractActionWithTooltip action = new AbstractActionWithTooltip("",
				UITools.createImageIcon("ambit2/ui/images/resultset_first.png"),"First") {
		...
		action = new AbstractActionWithTooltip("",
				UITools.createImageIcon("ambit2/ui/images/resultset_previous.png"),"Previous item") {
			public void actionPerformed(ActionEvent e) {
		...
		action = new AbstractActionWithTooltip("",
				UITools.createImageIcon("ambit2/ui/images/resultset_next.png"),"Next item") {
			public void actionPerformed(ActionEvent e) {
				AmbitObject o =  selectItem(currentIndex+1, isEditable());
			}
		};
		...
		action = new AbstractActionWithTooltip("",
				UITools.createImageIcon("ambit2/ui/images/resultset_last.png"),"Last item") {
			public void actionPerformed(ActionEvent e) {
