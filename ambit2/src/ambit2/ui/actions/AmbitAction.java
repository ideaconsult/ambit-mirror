...
public abstract class AmbitAction<Data> extends AbstractAction {
	 ...
	 * This method sets {@link ambit2.data.JobStatus} to {@link IJobStatus#STATUS_RUNNING}; 
	 * @param arg0
	 */
	 ...
	 * This method sets {@link ambit2.data.JobStatus} to {@link IJobStatus#STATUS_DONE};
	 */
	public void done() {
		if (userData instanceof ISharedData) {
