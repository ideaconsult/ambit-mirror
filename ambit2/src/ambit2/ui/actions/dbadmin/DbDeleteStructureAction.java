...
import ambit2.ui.actions.search.DbSearchAction;
import ambit2.data.molecule.SourceDataset;
import ambit2.database.readers.DbStructureReader;
import ambit2.database.writers.DbDeleteStructure;
...
public class DbDeleteStructureAction extends DbSearchAction {
    ...
    /*
     * (non-Javadoc)
     * @see ambit2.ui.actions.search.DbSearchAction#getSearchReader(java.sql.Connection, java.lang.Object, int, int)
     */
    ...
    /* (non-Javadoc)
     * @see ambit2.ui.actions.DbSearchAction#getWriter()
     */
