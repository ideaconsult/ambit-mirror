...
import ambit2.ui.actions.dbadmin.DbBatchImportAction;
import ambit2.ui.actions.dbadmin.DbBatchImportExperiments;
import ambit2.ui.actions.dbadmin.DbBatchImportQSARModels;
import ambit2.ui.actions.dbadmin.DbConnectionStatusAction;
import ambit2.ui.actions.dbadmin.DbCreateDatabaseAction;
import ambit2.ui.actions.dbadmin.DbCreateUserAction;
import ambit2.ui.actions.dbadmin.DbOpenAction;
import ambit2.ui.actions.dbadmin.DbStatisticsAction;
import ambit2.ui.actions.dbadmin.PackUniqueSMILES;
import ambit2.ui.actions.dbadmin.StartMySQLAction;
import ambit2.ui.actions.dbadmin.StopMySQLAction;
import ambit2.ui.actions.file.FileBatchProcessingAction;
import ambit2.ui.actions.file.FileExportQueryAction;
import ambit2.ui.actions.file.FileNewAction;
import ambit2.ui.actions.file.FileOpenAction;
import ambit2.ui.actions.process.CalculateMOPACAction;
import ambit2.ui.actions.process.DBCalculateAtomDistancesAction;
import ambit2.ui.actions.process.DBCalculateDescriptorsAction;
import ambit2.ui.actions.process.MoleculeEditAction;
import ambit2.ui.actions.search.DatasetSearchAction;
import ambit2.ui.actions.search.DbAliasSearchAction;
import ambit2.ui.actions.search.DbCASSearchAction;
import ambit2.ui.actions.search.DbCombinedSearchAction;
...
import ambit2.database.aquire.AquireSearchAction;
...
public class ActionFactory {
    ...
    public static void createSearchActions(ActionMap actions, Object userData, JFrame mainFrame) {
		...
		/*
		actions.put("Advanced search",new AmbitAction(userData,mainFrame,"Structure search",UITools.createImageIcon("ambit2/ui/images/search.png")) {
    ...
    public static void createDatabaseActions(ActionMap actions, Object userData, JFrame mainFrame) {
        ...
        actions.put("Import descriptors",new AmbitAction(userData,mainFrame,"Import descriptors",UITools.createImageIcon("ambit2/ui/images/chart_bar.png")) {
        	public void actionPerformed(ActionEvent arg0) {
