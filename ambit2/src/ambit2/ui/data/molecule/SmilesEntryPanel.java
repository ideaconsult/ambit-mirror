...
public class SmilesEntryPanel extends StructureEntryPanel implements ItemListener, ActionListener {
	...
	private void addWidgets( AmbitAction drawSmilesAction) {
        ...
        JButton backButton = new JButton(new AbstractAction("",UITools.createImageIcon("ambit2/ui/images/arrowleft_green_16.png")) {
        ...
        JButton forwardButton = new JButton(new AbstractAction("",UITools.createImageIcon("ambit2/ui/images/arrowright_green_16.png")) {
	...
	protected boolean createMoleculeFromSMILES(String smiles) {
    	...
    	IMolecule a = null;
    	try {
    		a = (IMolecule) sp.parseSmiles(smiles);
    	} catch (Exception x) {
    		a = null;
    		x.printStackTrace();
    	}
