...
import ambit2.ui.data.SelectPropertiesPanel;
	...
	protected JPanel createPanel(Color bgColor, Color fColor,int split) {
		...
		return new AtomcontainersListSpreadsheet(model,cell) {
			...
			protected JComponent addControls() {
		        ...
		        p.add(new MoleculesTableAction("Size",UITools.createImageIcon("ambit2/ui/images/size.png"),
		    	"Modify picture size") {
		        ...
		        p.add(new MoleculesTableAction("Fields",UITools.createImageIcon("ambit2/ui/images/settings.png"),
