...
public class SetOfAtomContainersTableModel extends AbstractTableModel implements PropertyChangeListener {
    protected IMoleculeSet atomContainers;
    protected ArrayList properties;
    
    public SetOfAtomContainersTableModel(IMoleculeSet atomContainers, ArrayList properties) {
        super();
    ...
    public synchronized IMoleculeSet getAtomContainers() {
        return atomContainers;
    }
    public synchronized void setAtomContainers(
    		IMoleculeSet atomContainers) {
