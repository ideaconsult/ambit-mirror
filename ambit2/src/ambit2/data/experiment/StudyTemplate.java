 ...
 * A template consists of a name, fields defining study conditions and fields defining study results. Each field has a name, units and a flag specifying whether it is a condition or a result. See {@link ambit2.data.experiment.DefaultTemplate} ,
 * {@link ambit2.data.experiment.DSSToxCarcinogenicityTemplate}, {@link ambit2.data.experiment.DSSToxERBindingTemplate},
 * {@link ambit2.data.experiment.DSSToxLC50Template} for specific examples. 
...
public class StudyTemplate extends AmbitList {
    ...
    /* (non-Javadoc)
     * @see ambit2.data.AmbitList#clone()
     */
