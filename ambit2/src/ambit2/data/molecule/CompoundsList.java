...
import ambit2.io.DelimitedFileReader;
...
/**
 * A List of {@link ambit2.data.molecule.Compound} 
...
public class CompoundsList extends AmbitList  {
	...
	/* (non-Javadoc)
	 * @see ambit2.data.AmbitList#createNewItem()
	 */
    ...
    public void addAllAtomContainers(IChemFile file) throws AmbitIOException {
        ...
        while (sequences.hasNext()) {
            Iterator<IChemModel> models = sequences.next().chemModels();
            while (models.hasNext()) {
                addSetOfMolecules(models.next().getMoleculeSet());
            }
        }
        return;
    }
    public void addSetOfMolecules(IMoleculeSet molecules) {
    ...
    /* (non-Javadoc)
     * @see ambit2.data.molecule.IMoleculesIterator#addMolecule(org.openscience.cdk.interfaces.AtomContainer)
     */
