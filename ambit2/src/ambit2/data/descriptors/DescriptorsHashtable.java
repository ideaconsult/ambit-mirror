...
/**
 * A hashtable of ( Object, {@link ambit.data.descriptors.DescriptorDefinition} ) pairs.
 * Used to provide correspondence between descriptor string name and {@link ambit.data.descriptors.DescriptorDefinition} or
 * between {@link org.openscience.cdk.qsar.IDescriptor} and {@link ambit.data.descriptors.DescriptorDefinition}.
...
public class DescriptorsHashtable extends Hashtable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2968286236435142686L;
