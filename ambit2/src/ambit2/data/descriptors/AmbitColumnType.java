...
import ambit2.processors.IdentifiersProcessor;

/**
 * Column type (the role in a model) as defined in {@link ambit.io.IColumnTypeSelection}
...
public class AmbitColumnType extends AmbitObject implements IColumnTypeSelection {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6155243939609857798L;
	protected static IdentifiersProcessor processor = null;
    /**
     *  
     * @param id integer column type identifier as defined in {@link ambit.io.IColumnTypeSelection} 
     */
	...
	/**
	 * @param name string column type identifier as defined in {@link ambit.io.IColumnTypeSelection}
	 */
