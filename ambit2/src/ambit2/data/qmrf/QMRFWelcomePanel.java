...
public class QMRFWelcomePanel extends JPanel implements IAmbitEditor<QMRFObject> {
	...
	public QMRFWelcomePanel(QMRFObject qmrf, boolean editable) {
        ...
        add(createText(html+"If you wish to submit the QMRF for inclusion in the <b>ECB Inventory of QSAR Models</b>, please do the following:<ul><li>Please, try to fill in the fields of the QMRF for the model of interest. If the field is not pertinent with the model you are describing, or if you cannot provide the requested information, please answer <i>\"no information available\"</i>. <li>Save the QMRF as xml file and send it to <a href=\"mailto:ecb.qsar@jrc.it\">ecb.qsar@jrc.it</a>. Please, use the following subject: <b>\"QMRF Submission\"</b>.</ul>ECB thanks you in advance for your collaboration in building the Inventory of QSAR Models. <br>More information on the Inventory or on the QMRF can be requested to ECB: <a href=\"mailto:ecb.qsar@jrc.it\">ecb.qsar@jrc.it</a> . Please, use the following subject <b>\"QMRF information\"</b>.</html>"));
        /*
