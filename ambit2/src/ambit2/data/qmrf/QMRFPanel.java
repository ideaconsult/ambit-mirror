...
public class QMRFPanel extends JPanel implements IAmbitObjectListener {
	...
	public QMRFPanel(QMRFObject qmrf) {
		...
		chapterIcons.put("1","ambit2/ui/images/application_form.png");
		chapterIcons.put("2","ambit2/ui/images/user_suit.png");
		chapterIcons.put("3","ambit2/ui/images/experiment_16.png");
		chapterIcons.put("4","ambit2/ui/images/chart_curve.png");
		chapterIcons.put("5","ambit2/ui/images/chart_pie.png");
		chapterIcons.put("6","ambit2/ui/images/benzene_16.jpg");
		chapterIcons.put("7","ambit2/ui/images/benzene_16.jpg");
		chapterIcons.put("8","ambit2/ui/images/book_open.png");
		chapterIcons.put("9","ambit2/ui/images/attachment.png");
	...
	public void setQmrf(QMRFObject qmrf) {
		...
		ShowChapterAction action = new ShowChapterAction(qmrf,editorPanel,UITools.createImageIcon("ambit2/ui/images/qmrf.png"));
		...
		while (chapters.hasNext()) {
			...
			if (icon == null) icon = "ambit2/ui/images/draw_16.png";
		...
		while (e.hasNext()) {
			...
			action = new ShowChapterAction(e.next(),editorPanel,UITools.createImageIcon("ambit2/ui/images/database.png"));
			b = new JToggleButton(action);
			group.add(b);
			toolbar.add(b);
			actions.add(action);		
