...
public class QMRFObject extends AmbitObject implements InterfaceQMRF, IAmbitObjectListener {
    ...
    protected String dtdSchema = "http://ambit2.acad.bg/qmrf/qmrf.dtd";
    protected String xmlSample = "http://ambit2.acad.bg/qmrf/qmrf.xml";
    protected String ttfFontUrl = "http://ambit2.acad.bg/qmrf/jws/times.ttf";
...
*/
	...
	/*
	 * (non-Javadoc)
	 * @see ambit2.data.XMLSerializable#fromXML(org.w3c.dom.Element)
	 */
    ...
    */
    ...
    protected Options createOptions() {
        ...
        Option dtdschema   = OptionBuilder.withLongOpt("dtd")
                            .withArgName( "url" )
                            .hasArg()
                            .withDescription(  "DTD schema location - URL where DTD schema resides (e.g. -dfile:///D:/src/ambit/qmrf.dtd or -dhttp://ambit2.acad.bg/qmrf/qmrf.dtd) ")
                            .create( "d" );
        ...
        if( line.hasOption( "d" ) ) {
            ...
            try {
                dtdSchema = url;
                 ...
                 logger.error(x);
                 dtdSchema = "http://ambit2.acad.bg/qmrf/qmrf.dtd"; 
