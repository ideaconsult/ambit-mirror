...
public class LiteratureEntry extends AmbitObject {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -786246142912629771L;
	...
	public AuthorEntry addAuthor(String n) {
		AuthorEntry author = new AuthorEntry(n);		
		authors.addItem(author);
		return author;
	}	
	...
	public void setEditable(boolean editable) {
		...
		if (authors!= null) {
			authors.setEditable(editable);
		}
		if (journal!=null) {
			journal.setEditable(editable);
		}
	}
}
