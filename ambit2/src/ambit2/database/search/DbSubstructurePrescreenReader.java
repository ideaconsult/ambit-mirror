 ...
 * {@link ambit2.database.processors.ReadSubstanceProcessor} and <br>
 * {@link ambit2.database.processors.SubstructureSearchProcessor} as in <br>
 * {@link ambit2.ui.actions.search.DbSubstructureSearchAction}<br>
...
public class DbSubstructurePrescreenReader extends DbSearchReader {
    ...
    /* (non-Javadoc)
     * @see ambit2.database.search.DbSearchReader#prepareSQLStatement(java.sql.Connection, org.openscience.cdk.interfaces.Molecule, java.lang.String)
     */
