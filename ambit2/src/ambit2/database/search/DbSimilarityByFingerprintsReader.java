 ...
 * Will not work if there are no fingerprints in the database! To generate fingerprints for the structures in database (once) use {@link ambit2.ui.actions.dbadmin.DBGenerator} with fingerprints option.
 * <pre>
...
See also {@link ambit2.ui.actions.search.DbSimilaritySearchAction}.
