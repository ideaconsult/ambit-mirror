...
import ambit2.data.descriptors.DescriptorsDefinitionList;
import ambit2.data.literature.ReferenceFactory;
import ambit2.data.molecule.SourceDataset;

/**
 * A complex descriptor query. <br>
 * Used by {@link ambit2.database.search.DbSearchDescriptors}, {@link ambit2.database.processors.ReadDescriptorsProcessor}.<br>
 * Visualization by {@link ambit2.ui.query.DescriptorQueryPanel}, {@link ambit2.ui.query.DescriptorQueryTableModel}.
  ...
  -9105.2666 |  -468.4965 |  -2710.90062956 | TOTAL ENERGY                                           |
   -715.3523 |   431.1553 |    -26.72242988 | FINAL HEAT OF FORMATION                                |
	...
	public void loadDefault() {
	 	...
	 	addItem(d7);
	 	DescriptorQuery d9 = new DescriptorQuery("ambit2.data.descriptors.SpherosityDescriptor",ReferenceFactory.createEmptyReference());
