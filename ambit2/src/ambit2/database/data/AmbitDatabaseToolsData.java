...
import ambit2.database.processors.BatchFactory;
...
/**
 * Extension of {@link ambit2.database.data.DefaultSharedDbData} to hold queries and results in {@link ambit2.applications.dbadmin.AmbitDatabase} application.
 * Example:
 * <pre>
...
//	            	QDbConnectionDialog.execute((JFrame)null,this);
	...
	*/
	/* (non-Javadoc)
	 * @see ambit2.database.IDataContainers#getMolecules()
	 */
	public DataContainer getMolecules() {
		return molecules;
	}
	/* (non-Javadoc)
	 * @see ambit2.database.IDataContainers#getQueries()
	 */
	...
	/* (non-Javadoc)
	 * @see ambit2.database.IDataContainers#setMolecules(ambit2.data.molecule.DataContainer)
	 */
