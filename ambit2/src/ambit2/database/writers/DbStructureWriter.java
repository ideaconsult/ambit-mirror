...
/**
 * Writes structures into database. This concerns table structure. Used in {@link ambit2.database.writers.DbSubstanceWriter}
...
public class DbStructureWriter extends AbstractDbStructureWriter {
	...
	public int write(int idsubstance,int idstructure, IChemObject object) throws AmbitException {
		...
		StringWriter w;
		try {
			//writes CML without properties
			Map<Object,Object> oldProps = object.getProperties();
			object.setProperties(new Hashtable<Object, Object>());
