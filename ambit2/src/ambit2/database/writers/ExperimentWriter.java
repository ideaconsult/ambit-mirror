...
/**
 * Writes {@link ambit2.data.experiment.Experiment} to database. The experimental data is expected to come as molecule property 
 * object.getProperty({@link AmbitCONSTANTS#EXPERIMENT}) of type {@link ambit2.data.experiment.Experiment} <br>
 * Used by {@link ambit2.database.writers.QSARPointWriter}, {@link ambit2.ui.actions.dbadmin.DbBatchImportExperiments}
