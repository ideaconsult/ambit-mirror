...
import ambit2.data.molecule.CompoundType;
 ...
 * Uses {@link ambit2.database.writers.DbStructureWriter} to write structures<br>
 * Uses {@link ambit2.database.writers.DbCASWriter} to write CAS numbers<br>
 * Uses {@link ambit2.database.writers.DbNameWriter} to write names<br>
 * Uses {@link ambit2.database.writers.DbAliasWriter} to write aliases<br>
 * Uses {@link ambit2.database.writers.PropertyDescriptorWriter} to write descriptors<br>
 *<b>Example</b>:
 <pre>
 ...
 * See also {@link ambit2.ui.actions.dbadmin.DbBatchImportAction}.
...
public class DbSubstanceWriter extends AbstractDbStructureWriter {
	...
	private int writeSubstance(int idsubstance,int idstructure, IAtomContainer molecule) throws AmbitException {
		...
		try {
			...
			if (substtype== null) MoleculeTools.analyzeSubstance((AtomContainer)molecule);
			...
			throw new AmbitException("Error writing substance\t"+ x.getMessage()+molecule.getProperties(),x);
		}
