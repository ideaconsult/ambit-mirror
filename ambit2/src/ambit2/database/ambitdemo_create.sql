...
CREATE TABLE `cas` (
  ...
  KEY `cas_casno` (`casno`),
  CONSTRAINT `cas_ibfk_1` FOREIGN KEY (`idstructure`) REFERENCES `structure` (`idstructure`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `localdvalues` (
  ...
  `value` float(10,4) NOT NULL default '0.0000',
  PRIMARY KEY  (`iddescriptor`),
  ...
  CONSTRAINT `localdvalues_ibfk_2` FOREIGN KEY (`idstructure`) REFERENCES `structure` (`idstructure`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `dvalues` (
  ...
  CONSTRAINT `dvalues_ibfk_1` FOREIGN KEY (`iddescriptor`) REFERENCES `ddictionary` (`iddescriptor`) ON UPDATE CASCADE,
  CONSTRAINT `dvalues_ibfk_2` FOREIGN KEY (`idstructure`) REFERENCES `structure` (`idstructure`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `datasets` (
  ...
  CONSTRAINT `datasets_ibfk_1` FOREIGN KEY (`iddsname`) REFERENCES `dsname` (`iddsname`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `datasets_ibfk_2` FOREIGN KEY (`idstructure`) REFERENCES `structure` (`idstructure`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
