...
/**
 * Reads structures without precalculated pairwise atom distances from the database. Used by {@link ambit2.ui.actions.process.DBCalculateAtomDistancesAction}
...
public class DbStructureDistanceReader extends DbStructureReader {
    ...
    /* (non-Javadoc)
     * @see ambit2.database.DbReader#close()
     */
