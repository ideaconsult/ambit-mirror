 ...
 * 
 * Database API<br>
 * Reads, writes and looks for {@link ambit2.data.model.Model}s in the database
...
//			add user to model 
	 ...
	 * @param idqsar {@link Model} identifier as in database
	 * @param idStructure {@link ambit2.misc.AmbitCONSTANTS#AMBIT_IDSTRUCTURE} structure identifier as in database
