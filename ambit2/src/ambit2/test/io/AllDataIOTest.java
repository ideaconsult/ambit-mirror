...
import ambit2.io.InteractiveIteratingMDLReader;
import ambit2.io.IteratingDelimitedFileReader;
...
public class AllDataIOTest extends TestCase {
    ...
    public void runTestListener(IIteratingChemObjectReader reader, 
			...
			reader.addChemObjectIOListener(new AmbitSettingsListener(null,IOSetting.LOW) {
			    /* (non-Javadoc)
                 * @see ambit2.io.AmbitSettingsListener#processIOSettingQuestion(org.openscience.cdk.io.setting.IOSetting)
                 */
