...
public class TestValueLatchPairEditor extends TestCase {
	public void test() throws Exception {
		ValueLatchPair<LoginInfo> vlp = new ValueLatchPair<LoginInfo>(new LoginInfo());
		IAmbitEditor<ValueLatchPair<LoginInfo>> e = EditorPreferences.getEditor(vlp);
