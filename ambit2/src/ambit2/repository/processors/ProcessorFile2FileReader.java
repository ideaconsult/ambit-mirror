 ...
 */
public class ProcessorFile2FileReader implements IProcessor<File,IIteratingChemObjectReader> {
    public IIteratingChemObjectReader process(File target) throws ProcessorException {
        try {
