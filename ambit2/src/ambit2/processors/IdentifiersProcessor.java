...
import ambit2.config.IColumnTypeSelection;
import ambit2.config.Resources;
import ambit2.exceptions.AmbitException;

/**
 * Looks up molecule identifiers from a predefined list and "normalizes" them.
 * Molecule identifiers are simple some predefined properties, like CAS, NAME. These comes in many different flavours and it is 
 * useful to have them "standardized". 
 * Example:  <br>
 * If the molecule has property CAS#="50-00-0" , after processing the molecule will have property CAS_RN="50-00-0"
 * The lookup table can be set by {@link #setIdentifiers(Hashtable)} or The lookup table can be set by 
 * {@link #addIdentifiers(Hashtable)}.<br>
...
public class IdentifiersProcessor extends DefaultAmbitProcessor {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4593674915589466472L;
	protected Map<Object,Object> identifiers;
	protected static final char casDelimiter = '-';
    ...
    public IdentifiersProcessor() {
        identifiers = new Hashtable<Object,Object>();
     ...
     * @param property 
     * @return one of {@link IColumnTypeSelection#_ctCAS},{@link IColumnTypeSelection#_ctSMILES},
     * {@link IColumnTypeSelection#_ctChemName},{@link IColumnTypeSelection#_ctRowID}
     */
     ...
     * @param properties
     */
    public void guessProperties(Map<Object,Object> properties) {
		...
		if (cas != null ) {
			    ...
			    try {
				    cas = hyphenateCAS(cas.toString());
				        ...
				        co.setProperty(this.getClass().getName(),Resources.getString(Resources.err_invalidcas));
				    }				
	 ...
	 * @param identifiers
	 */
	public void setIdentifiers(Map<Object,Object> identifiers) {
	 ...
	 * @param ids
	 */
	public void addIdentifiers(Hashtable<String,Object> ids) {
	    
		this.identifiers.putAll(ids);
	}	
	/**
