...
public class OTFeatures  extends OTProcessingContainers<OTFeature> {
	...
	public static OTFeatures features() throws Exception  { 
	 ...
	 public static OTFeatures features(Reference reference) throws Exception  { 
		    return new OTFeatures(reference.toString());
	 }
	 public static OTFeatures features(String uri) throws Exception  { 
		    return new OTFeatures(uri);
	 }
	public OTFeatures() {
		this(null);
	}
	
	public OTFeatures(String uri) {
		super(uri);
	}
