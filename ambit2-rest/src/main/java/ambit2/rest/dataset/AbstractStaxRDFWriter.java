...
public abstract class AbstractStaxRDFWriter<INPUT,OUTPUT> extends DefaultAmbitProcessor<INPUT,OUTPUT> {
	...
	public QueryURIReporter<INPUT, IQueryRetrieval<INPUT>> getUriReporter() {
		return uriReporter;
	}
	public void setUriReporter(
			QueryURIReporter<INPUT, IQueryRetrieval<INPUT>> uriReporter) {
		this.uriReporter = uriReporter;
	}
	public XMLStreamWriter getOutput() throws AmbitException {
		return output;
	}
