...
/**
 * Renders HTML by freemarker template, if htmlByTemplate is true. Otherwise,
 * uses the old behaviour (htmlreporter).
 * 
 * @author nina
 * 
 */
public class FreeMarkerResource extends ProtectedResource implements
		IFreeMarkerSupport {
