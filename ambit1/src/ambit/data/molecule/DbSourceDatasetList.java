...
/**
 * Same as parent class, but with a procedure to delete dataset from the database
 * @author nina
 *
 */
public class DbSourceDatasetList extends SourceDatasetList {
	protected final DbConnection dbconnection;
	
	public DbSourceDatasetList(DbConnection c) {
		super();
		this.dbconnection = c;
	}
	@Override
	public Object remove(int i) {
		...
		try {
			if (d.deleteSourceDataset((SourceDataset)getItem(i))) {
