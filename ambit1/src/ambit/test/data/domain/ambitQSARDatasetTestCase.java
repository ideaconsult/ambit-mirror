...
/**
 * JUnit test for {@link ambit.domain.QSARDataset} 
...
//		assertEquals(1,data.getNDescriptors());		
		...
		try {
			AmbitObject o = data.createNewItem();
	...
	public void testDefaultReadDataGetItem() {
	    try {
			...
			assertFalse(p.getCompound().getName().equals(""));
