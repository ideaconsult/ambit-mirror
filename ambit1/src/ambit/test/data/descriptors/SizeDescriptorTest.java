...
import ambit.data.descriptors.CrossSectionalDiameterDescriptor;
import ambit.data.descriptors.DescriptorFactory;
import ambit.data.descriptors.DescriptorsHashtable;
import ambit.data.descriptors.MaximumDiameterDescriptor;
import ambit.data.descriptors.PlanarityDescriptor;
import ambit.data.descriptors.SizeDescriptor;
...
public class SizeDescriptorTest extends TestCase {
	...
	public void testProcessor() {
		try {
			...
			CalculateDescriptors processor = new CalculateDescriptors(descriptors,FastTemplateHandler3D.getInstance());
