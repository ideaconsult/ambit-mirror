...
public class Mopac7WriterTest extends TestCase {
    ...
    public void test() {
        try {
            Mopac7Writer writer = new Mopac7Writer(
                    new OutputStreamWriter(new FileOutputStream("helper/ambit.processors.mopac.dat")));
    ...
    public void testNCI() {
        try {
            ...
            int n = 0;
            MopacShell shell = new MopacShell("helper","ambit.processors.mopac.exe");
            while (reader.hasNext()) {
                ...
                if (o instanceof ChemObject) {
                    ...
                    /*
                    Object e = ((Molecule) o).getProperty("EIGENVALUES");
                    assertNotNull(e);
                    System.out.println(e);

                    e = ((Molecule) o).getProperty("NO. OF FILLED LEVELS");
                    assertNotNull(e);
                    System.out.println(e);
                    
                    e = ((Molecule) o).getProperty("EHOMO");
                    assertNotNull(e);
                    System.out.println(e);
                    
                    e = ((Molecule) o).getProperty("ELUMO");
                    assertNotNull(e);
                    System.out.println(e);
                    */
                }
