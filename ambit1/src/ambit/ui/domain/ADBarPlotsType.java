...
public class ADBarPlotsType extends AmbitObjectFixedValues implements
	...
	/* (non-Javadoc)
	 * @see ambit.ui.domain.IADPlotsType#getXLabel(ambit.data.domain.QSARDataset)
	 */
	...
	/* (non-Javadoc)
	 * @see ambit.ui.domain.IADPlotsType#getYLabel(ambit.data.domain.QSARDataset)
	 */
	...
	/* (non-Javadoc)
	 * @see ambit.ui.domain.IADPlotsType#isXDescriptor()
	 */
	...
	/* (non-Javadoc)
	 * @see ambit.ui.domain.IADPlotsType#isYDescriptor()
	 */
	...
	/* (non-Javadoc)
	 * @see ambit.ui.domain.IADPlotsType#getXindex()
	 */
	...
	/* (non-Javadoc)
	 * @see ambit.ui.domain.IADPlotsType#setXindex(int)
	 */
	...
	/* (non-Javadoc)
	 * @see ambit.ui.domain.IADPlotsType#getYindex()
	 */
	...
	/* (non-Javadoc)
	 * @see ambit.ui.domain.IADPlotsType#setYindex(int)
	 */
