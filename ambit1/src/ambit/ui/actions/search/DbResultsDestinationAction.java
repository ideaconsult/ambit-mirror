 ...
 * <ul>
 * <li>{@link ambit.database.data.ISharedDbData#MEMORY_LIST} Add query results into the list in memory.
 * <li>{@link ambit.database.data.ISharedDbData#MEMORY_CURRENT} Replace current molecule in memory with the query result.
 * <li>{@link ambit.database.data.ISharedDbData#RESULTS_FILE}  Export query results to a file.
 * </ul>
 * These options are interpreted by {@link ambit.ui.actions.search.DbSearchAction}. Other application may invent other interpretations.
...
public class DbResultsDestinationAction extends AmbitAction implements Observer {
	...
	public DbResultsDestinationAction(Object userData, JFrame mainFrame,
			String arg0) {
		this(userData, mainFrame, arg0,UITools.createImageIcon("ambit/ui/images/settings.png"));
	}
