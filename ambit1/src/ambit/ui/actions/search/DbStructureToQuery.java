...
/**
 * Loads current structure from {@link ambit.database.data.AmbitDatabaseToolsData#getMolecules()} 
 * to {@link ambit.database.data.AmbitDatabaseToolsData#getQueries()}, thus making available the current structure 
 * for query. See example for {@link ambit.database.data.AmbitDatabaseToolsData}.
