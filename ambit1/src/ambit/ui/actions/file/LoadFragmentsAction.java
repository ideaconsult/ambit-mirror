...
public class LoadFragmentsAction extends AmbitAction {

	public LoadFragmentsAction(Object userData, Container mainFrame) {
		super(userData, mainFrame,"Open");
		putValue(SHORT_DESCRIPTION,"Load functional groups from a file");
	}
	@Override
	public void actionPerformed(ActionEvent arg0) {
        File file = MyIOUtilities.selectFile(mainFrame,null,
                ((AmbitDatabaseToolsData)userData).getDefaultDir(),
                FuncGroupsDescriptorFactory.extensions,FuncGroupsDescriptorFactory.extensionDescription,true);
        try {
        
	        FuncGroupsDescriptorFactory.getFragments(FuncGroupsDescriptorFactory.getDocument(file),
