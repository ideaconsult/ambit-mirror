...
public class DbConnectionStatusAction extends AmbitAction implements Observer {
    protected static ImageIcon connectedIcon = UITools.createImageIcon("ambit/ui/images/database_connected.png");
    protected static ImageIcon disconnectedIcon = UITools.createImageIcon("ambit/ui/images/database_notconnected.png");
    /**
     * @param userData
     * @param mainFrame
     */
