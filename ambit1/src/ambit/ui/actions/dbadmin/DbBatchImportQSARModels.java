...
import ambit.database.writers.QSARPointWriter;
import ambit.io.MolPropertiesIOSetting;
import ambit.io.QSARSettingsListener;
...
public class DbBatchImportQSARModels extends DbBatchImportAction {
	...
	public DbBatchImportQSARModels(Object userData, JFrame mainFrame,String caption ) {
		this(userData, mainFrame,caption,UITools.createImageIcon("ambit/ui/images/database.png"));
	}	
	public DbBatchImportQSARModels(Object userData, JFrame mainFrame) {
		this(userData, mainFrame,"Import QSAR model",UITools.createImageIcon("ambit/ui/images/database.png"));
	}
