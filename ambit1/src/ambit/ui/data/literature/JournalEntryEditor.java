...
public class JournalEntryEditor extends AbstractAmbitEditor {
	public JournalEntryEditor() {
		super("Journal",null);
	}

	public JournalEntryEditor(String caption, AmbitObject object) {
		super(caption, object);
	}

	protected AbstractPropertyTableModel createTableModel(AmbitObject object) {
		return new JournalEntryTableModel(object);
	}
