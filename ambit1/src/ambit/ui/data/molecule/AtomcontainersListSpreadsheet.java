...
import ambit.data.molecule.IMoleculesIterator;
import ambit.ui.AmbitColors;
import ambit.ui.UITools;
import ambit.ui.actions.process.MoleculeEditAction;
import ambit.ui.data.ImageCellRenderer;
import ambit.ui.data.MoleculeGridCellRenderer;
import ambit.ui.data.PropertiesCellRenderer;
...
public class AtomcontainersListSpreadsheet extends JPanel {
    ...
    protected JComponent addControls() {
        ...
        p.add(new MoleculesTableAction("Info",UITools.createImageIcon("ambit/ui/images/dataset.png"),"Dataset information") {
            public void actionPerformed(ActionEvent e) {
                info();
            }
        });                     
        ...
        p.add(new MoleculesTableAction("Go to record",UITools.createImageIcon("ambit/ui/images/enter.png"),"Go to record number") {
            public void actionPerformed(ActionEvent e) {
                gotoRecord();
            }
        });
        p.add(new MoleculesTableAction("Search",UITools.createImageIcon("ambit/ui/images/search.png"),"Search by CAS RN") {
            public void actionPerformed(ActionEvent e) {
        ...
        p.add(new MoleculesTableAction("Edit",UITools.createImageIcon("ambit/ui/images/draw_16.png"),"Edit current structure") {
            public void actionPerformed(ActionEvent e) {
                editAtomContainter();
            }
        });
