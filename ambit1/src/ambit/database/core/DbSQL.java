...
lpad(hex(fp16),16,0)
	...
	public static String getExactSearchSQL(IAtomContainer mol,int page, int pagesize, double threshold) {
			...
			if (s != null) { 
				...
				SmilesGenerator generator = new SmilesGenerator(DefaultChemObjectBuilder.getInstance());
				try {
	...
	*/
	public static String getExactSearchSQL(Hashtable properties,int page, int pagesize, double threshold, List parameters) {
			String[][] conditions={
