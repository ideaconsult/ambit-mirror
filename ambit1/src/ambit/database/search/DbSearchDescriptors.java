...
/**
 * Search by descriptors (ranges, equation, inequality, distances}. The query is specified by {@link ambit.database.query.DescriptorQueryList}.
 * <br>Example:
 <pre>
 	    try {
 ...
 * </pre>
 * The reader can be attached to {@link ambit.io.batch.DefaultBatchProcessing} which uses for example 
 * {@link ambit.io.DelimitedFileWriter} to write the results above into comma delimited file.<br>
 * See also {@link ambit.ui.actions.search.DbDescriptorsSearchAction}.
...
public class DbSearchDescriptors extends DbStructureReader {
	 ...
	 * 
	 * @param connection
	 * @param descriptors  The query {@link ambit.database.query.DescriptorQueryList}
