 ...
 * Will not work if there are no atom environments in the database! To generate atom environments (once) use {@link ambit.ui.actions.dbadmin.DBGenerator} with atom environment option.<br>
