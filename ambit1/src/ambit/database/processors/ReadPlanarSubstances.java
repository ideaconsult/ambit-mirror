...
/**
 * Reads only planar structures from the database. This is achieved by filtering compounds with {@link ambit.data.descriptors.SpherosityDescriptor} < 0.2
...
public class ReadPlanarSubstances extends ReadStructureProcessor {
    ...
    public String getSQL() {
    	String sql = 
    	    ...
    	    "\nwhere structure.idsubstance =? and name=\"ambit.data.descriptors.SpherosityDescriptor\" and value <=0.2";
