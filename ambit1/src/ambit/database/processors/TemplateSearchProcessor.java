...
/**
 * Expects {@link ambit.data.experiment.StudyTemplate} object in {@link #process(Object)} method.
 * Searches the database for the template name. If found, assigns {@link ambit.data.experiment.StudyTemplate}.setId()
