...
/**
 * Reads identifiers from database (alias table) and assigns them to the molecule . See example at {@link ambit.database.search.DbSimilarityByAtomenvironmentsReader}.
