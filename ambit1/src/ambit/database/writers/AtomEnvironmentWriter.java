...
/**
 * Writes atom enwironments to database. Atom enviromnents are expected as molecule properties as generated from {@link ambit.processors.structure.AtomEnvironmentGenerator}.
 * Used in {@link ambit.ui.actions.dbadmin.DBGenerator}
...
public class AtomEnvironmentWriter extends AbstractDbStructureWriter {
    ...
    /* (non-Javadoc)
     * @see ambit.database.writers.AbstractDbStructureWriter#write(int, org.openscience.cdk.interfaces.ChemObject)
     */
    /* (non-Javadoc)
     * @see ambit.database.writers.AbstractDbStructureWriter#write(org.openscience.cdk.interfaces.ChemObject)
     */
    ...
    /* (non-Javadoc)
     * @see ambit.database.writers.DefaultDbWriter#prepareStatement()
     */
    ...
    /* (non-Javadoc)
     * @see ambit.database.writers.DefaultDbWriter#close()
     */
    ...
    /* (non-Javadoc)
     * @see ambit.database.writers.AbstractDbStructureWriter#toString()
     */
