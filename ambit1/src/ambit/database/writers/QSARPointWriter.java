...
import ambit.data.model.PredictedValue;
 ...
 * Used by {@link ambit.ui.actions.dbadmin.DbBatchImportQSARModels}<br>
 * Expects object.getProperty(AmbitCONSTANTS.PREDICTED) to be {@link ambit.data.model.PredictedValue}<br>
 * object.getProperty(AmbitCONSTANTS.EXPERIMENT) to be {@link ambit.data.experiment.Experiment}
