 ...
 * {@link ambit.data.molecule.MolProperties} and {@link ambit.io.AmbitSettingsListener}. See exapmle at {@link ambit.database.writers.DbSubstanceWriter}.
...
public class MolPropertiesIOSetting extends IOSetting {
    ...
    public MolPropertiesIOSetting(Hashtable properties, int level, String question) {
