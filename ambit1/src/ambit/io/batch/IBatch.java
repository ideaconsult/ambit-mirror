 ...
 * processor {@link ambit.processors.IAmbitProcessor} - which process compounds one by one (e.g. calculates descriptors, generates SMILES, etc.) <br>
...
public interface IBatch extends Serializable {
	 ...
	 * Used in for example in {@link ambit.servlets.AmbitServlet}
