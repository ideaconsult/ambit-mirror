...
import ambit.io.IReadWriteStream;
...
/*
	...
	public void randomData(double[] meanvector) {
		if ((npoints >0) && (ndescriptors >0)) {
			initData();
			ambit.stats.Tools.GaussianClusters(data,npoints,ndescriptors, meanvector,2);
	...
	*/
	...
	/* (non-Javadoc)
     * @see ambit.io.IReadWriteStream#load(java.io.InputStream)
     */
