 ...
 * Used in {@link ambit.applications.discovery.AmbitDiscoveryApp} application 
...
public class DataModule extends DefaultSharedDbData{
	...
	*/
	...
	/* (non-Javadoc)
     * @see ambit.data.ISharedData#getMolecule()
     */
    ...
    /* (non-Javadoc)
     * @see ambit.data.ISharedData#newMolecule()
     */
    ...
    /* (non-Javadoc)
     * @see ambit.data.ISharedData#setMolecule(org.openscience.cdk.interfaces.Molecule)
     */
