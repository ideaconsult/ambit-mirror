...
/**
 * Abstract class for similarity analysis by {@link ambit.data.descriptors.AtomEnvironmentDescriptor}.
...
public abstract class DataCoverageAtomEnvironmentCore extends DataCoverage {
	...
	protected SmilesParser sp = null;
	...
	protected IMolecule getMolecule(Compound cmp) throws Exception {
		...
		if (mol == null) {
		    ...
		    if (!smiles.equals("")) {
		        if (sp ==null) sp = new SmilesParser();
		        try {
