...
import ambit.data.descriptors.SpherosityDescriptor;
import ambit.exceptions.AmbitException;

/**
 * Calculates {@link ambit.data.descriptors.SpherosityDescriptor} and verifies if the value is < {@link #planarityThreshold} <br>
