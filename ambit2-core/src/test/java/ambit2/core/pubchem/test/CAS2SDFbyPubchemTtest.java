...
*/	
	...
	@Test public void test() throws Exception {
		...
		new File("data/pug/100-00-5.sdf").delete();
		new File("data/pug/1000-90-4.sdf").delete();
		new File("data/pug/100019-57-6.sdf").delete();
		Assert.assertTrue(new File("data/pug/100-00-5.xml").exists());
		Assert.assertTrue(new File("data/pug/1000-90-4.xml").exists());
		Assert.assertTrue(new File("data/pug/100019-57-6.xml").exists());
		
		batch.setResultDir("data/pug");
		Assert.assertEquals(new Integer(3),batch.process("data/pug"));
		Assert.assertTrue(new File("data/pug/100-00-5.sdf").exists());
		Assert.assertTrue(new File("data/pug/1000-90-4.sdf").exists());
		Assert.assertTrue(new File("data/pug/100019-57-6.sdf").exists());
	}
