...
public abstract class AbstractStructureProcessor implements
	...
	protected static Logger logger = Logger.getLogger(AbstractStructureProcessor.class.getName());
	...
	public IAtomContainer atomtypes2property( 
			IAtomContainer mol, Object compareWith, boolean sparseProperties)
			throws Exception {
		return atomtypes2property(at_property,mol, compareWith, sparseProperties);
	}
	/**
	 * Used as criteria whether to assign atom types as properties 
	 * e.g. assign only if charged atoms. Subclass to define your own. 
	 * @param atom
	 * @return
	 */
