...
<li>
	...
	<ul>
		...
		<li><a href="javascript:;" onclick="alert('Not implemented');" title="Search all IUC substances with defined parameters hit list shows IUC substances composition and structure">Find data and structures</a></li>
	</ul>
</li>
<li>
