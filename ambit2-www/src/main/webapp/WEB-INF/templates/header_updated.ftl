...
<!--
	<script type='text/javascript' src='${ambit_root}/jquery/jquery-1.10.2.js'></script>
	-->
	<script type="text/javascript" src="${ambit_root}/jquery/jquery.cookie.js"></script>
	<!--
	<script type='text/javascript' src='${ambit_root}/jquery/jquery-ui-1.10.4.custom.min.js'></script>
	-->
