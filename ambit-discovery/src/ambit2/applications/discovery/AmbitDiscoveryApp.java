 ...
 * 
 */
package ambit2.applications.discovery;
...
import ambit2.domain.AtomEnvironmentDistanceType;
...
import ambit2.ui.domain.ADActionPanel;
import ambit2.ui.domain.ADDataSetDialog;
import ambit2.ui.domain.ADDataSetPanel;
import ambit2.ui.domain.ADDataSetsPanel;
import ambit2.ui.domain.ADGUIListener;
import ambit2.ui.domain.ADPanel;
import ambit2.ui.domain.ADStatsPanel;
...
public class AmbitDiscoveryApp extends CoreApp {
	...
	public AmbitDiscoveryApp(String title, int w , int h,String[] args ) {
		...
		Package adPackage = Package.getPackage("ambit2.applications");
...
//            button = toolBar.add(action);
	...
	/* (non-Javadoc)
	 * @see ambit2.applications.CoreApp#createMenuBar()
	 */
	...
	/* (non-Javadoc)
	 * @see ambit2.applications.CoreApp#createWidgets(javax.swing.JFrame, javax.swing.JPanel)
	 */
