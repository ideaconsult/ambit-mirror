...
public abstract class WFCAbstractAction extends MWFAbstractAction {

    protected IWorkflowContextFactory wfcFactory;
    
    public WFCAbstractAction(IWorkflowContextFactory wfc) {
        super("Workflow context action");
        setWfcFactory(wfc);
    }
