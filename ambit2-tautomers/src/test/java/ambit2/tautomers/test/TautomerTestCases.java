...
public class TautomerTestCases extends TestCase
{
	...
	*/
	...
	{	
		int res = tt.testCase("O=CC", 
				new String[]{"O=CC", "OC=C"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("CC=NO", 
				new String[]{"ONC=C", "ON=CC", "O=NCC"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("CC(N)=O", 
				new String[]{"OC(=C)N", "O=C(N)C", "N=C(O)C"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("CC(=O)OC(C)=O", 
				new String[]{"OC(OC(O)=C)=C", "O=C(OC(O)=C)C", "O=C(OC(=O)C)C"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("CC(=O)NN", 
				new String[]{"OC(=C)NN", "O=C(NN)C", "OC(=NN)C", "N=NC(O)C"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("CC(=O)C", 
				new String[]{"OC(=C)C", "O=C(C)C"}, 
				FlagPrintTautomers);
	...
	{	
		tt.tman.tautomerFilter.FlagApplyDuplicationCheckIsomorphism = false;
		int res = tt.testCase("CC(=O)C", 
				new String[]{"OC(=C)C", "O=C(C)C", "OC(=C)C"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("CC(OC(C)=O)C(C)=O", 
				new String[]{"OC(OC(C(O)=C)C)=C", "OC(OC(=C(O)C)C)=C", "O=C(C)C(OC(O)=C)C", "O=C(OC(C(O)=C)C)C", "O=C(OC(=C(O)C)C)C", "O=C(OC(C(=O)C)C)C" }, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("CC(=O)CC(C)=O", 
	...
	{	
		int res = tt.testCase("CC(=O)C1CCOC1=O", 
				new String[]{"OC=1OCCC=1C(O)=C", "O=C(C1=C(O)OCC1)C", "O=C1OCCC1C(O)=C", "O=C1OCCC1C(=O)C", "O=C1OCCC1=C(O)C"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("CC(=O)C1CCCC1=O", 
				new String[]{"OC(=C)C1=C(O)CCC1", "O=C(C1=C(O)CCC1)C", "OC(=C)C1C(O)=CCC1", "O=C(C)C1C(O)=CCC1", "O=C1CCCC1(C(O)=C)", "O=C(C)C1C(=O)CCC1", "OC1=CCCC1=C(O)C", "O=C1C(=C(O)C)CCC1"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("CC(=O)NC(N)=S", 
				new String[]{"N=C(NC(O)=C)S", "O=C(NC(=N)S)C", "N=C(N=C(O)C)S", "OC(N=C(N)S)=C", "O=C(N=C(N)S)C", "OC(=C)NC(N)=S", "O=C(NC(N)=S)C", "OC(=NC(N)=S)C"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("NC(=O)CCCCC(N)=O", 
				new String[]{"OC(N)=CCCC=C(O)N", "O=C(N)CCCC=C(O)N", "N=C(O)CCCC=C(O)N", "O=C(N)CCCCC(=O)N", "O=C(N)CCCCC(=N)O", "N=C(O)CCCCC(=N)O"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("O=C1CC(=O)NC(=O)N1", 
				new String[]{"O=C1N=C(O)NC(O)=C1", "O=C1C=C(O)N=C(O)N1", "O=C1N=C(O)NC(=O)C1", "Oc1nc(O)cc(O)n1", "O=C1N=C(O)N=C(O)C1", "O=C1C=C(O)NC(=O)N1", "O=C1NC(=O)CC(=O)N1", "O=C1N=C(O)C=C(O)N1", "O=C1N=C(O)CC(=O)N1", "O=C1N=C(O)CC(O)=N1"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("NC(CC(N)=O)C(O)=O", 
				new String[]{"OC(O)=C(N)C=C(O)N", "O=C(O)C(N)C=C(O)N", "N=C(C=C(O)N)C(O)O", "O=C(N)C=C(N)C(O)O", "O=C(N)CC(N)=C(O)O", "O=C(O)C(N)CC(=O)N", "O=C(N)CC(=N)C(O)O", "N=C(O)C=C(N)C(O)O", "N=C(O)CC(N)=C(O)O", "O=C(O)C(N)CC(=N)O", "N=C(O)CC(=N)C(O)O", "O=C(O)C(N)=CC(O)N", "O=C(O)C(=N)CC(O)N"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("CCC(C)=NO", 
				new String[]{"ONC(=C)CC", "ONC(=CC)C", "ON=C(C)CC", "O=NC(C)CC"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("CN1C(N)=CC(=O)N(C)C1=O", 
	...
	{	
		int res = tt.testCase("CC(=O)NC1=CC=CC=C1", 
				new String[]{"OC(=C)Nc1ccccc1", "O=C(Nc1ccccc1)C", "OC(N=C1C=CC=CC1)=C", "O=C(N=C1C=CC=CC1)C", "OC(=Nc1ccccc1)C", "OC(N=C1C=CCC=C1)=C", "O=C(N=C1C=CCC=C1)C"}, 
				FlagPrintTautomers);
	...
	{	
		...
		int res = tt.testCase("CC(=O)NC1=CC=CC=C1", 
				new String[]{"OC(=C)Nc1ccccc1", "O=C(Nc1ccccc1)C", "OC(N=C1C=CC=CC1)=C", "O=C(N=C1C=CC=CC1)C", "OC(=Nc1ccccc1)C", "OC(=C)Nc1ccccc1", "O=C(Nc1ccccc1)C", "OC(N=C1C=CC=CC1)=C","O=C(N=C1C=CC=CC1)C", "OC(=Nc1ccccc1)C", "OC(N=C1C=CCC=C1)=C", "O=C(N=C1C=CCC=C1)C"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("O=C1NC2NC(=O)NC2N1", 
				new String[]{"OC1=NC2N=C(O)NC2(N1)", "OC1=NC2NC(O)=NC2(N1)", "O=C1NC2N=C(O)NC2(N1)", "O=C1NC2NC(=O)NC2(N1)"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("NC1=NC=NN1", 
				new String[]{"n1cnc(N)n1", "N1=NCN=C1N", "n1nc(N)nc1", "N=C1NN=CN1", "N=C1N=NCN1", "n1cnnc1N", "N=C1N=CNN1", "N1=NC(N=C1)N"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("O=C1CSC(=O)C1", 
	...
	{	
		int res = tt.testCase("OC(=O)C1=CC(=O)NC(O)=C1", 
				new String[]{"O=C(O)c1cc(O)nc(O)c1", "O=C(O)C1=CC(O)=NC(=O)C1", "O=C(O)C1=CC(=O)NC(O)=C1", "O=C(O)C1=CC(=O)N=C(O)C1", "O=C(O)C1=CC(=O)NC(=O)C1"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("OC(=O)C=CC1=CN=CN1", 
				new String[]{"O=C(O)C=Cc1cncn1", "O=C(O)C=CC1=NC=NC1", "O=C(O)C=Cc1ncnc1", "OC(O)=CC=C1N=CN=C1", "O=C(O)CC=C1N=CN=C1","O=C(O)C=CC1N=CN=C1"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("NC1CONC1=O", 
	...
	{	
		int res = tt.testCase("O=C1CCC(=O)CC1", 
				new String[]{"OC1=CC=C(O)CC1", "OC=1C=CC(O)CC=1", "O=C1C=CC(O)CC1", "OC1=CCC(O)=CC1", "O=C1CC=C(O)CC1", "O=C1CCC(=O)CC1"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("NC1=CC=C(O)C=C1", 
				new String[]{"Oc1ccc(N)cc1", "O=C1C=CC(N)=CC1", "N=C1C=CC(O)=CC1", "O=C1C=CC(=N)CC1", "N=C1C=CC(O)C=C1", "O=C1C=CC(N)C=C1"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("NC1=CC=CC(O)=C1", 
				new String[]{"Oc1cccc(N)c1", "O=C1C=CC=C(N)C1", "Oc1cccc(N)c1",
				"O=C1C=CCC(N)=C1", "N=C1C=CC=C(O)C1", "N=C1C=C(O)C=CC1",
				"O=C1C=CCC(=N)C1", "O=C1C=C(N)C=CC1", "O=C1CC=CC(=N)C1",
		"N=C1C=CCC(O)=C1"}, 
		FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("NC1=C(O)C=CC=C1", 
				new String[]{"Oc1ccccc1(N)", "O=C1C=CC=CC1(N)", "N=C1C=CC=CC1(O)",
				"Oc1ccccc1(N)", "O=C1C(N)=CC=CC1", "N=C1C(O)=CC=CC1",
				"O=C1C(=N)CC=CC1", "N=C1C=CCC=C1(O)", "O=C1C(=N)C=CCC1",
	...
	{	
		...
		int res = tt.testCase("NCC1=CC=CC=N1", 
				...
				"N=CC1=CCC=CN1", "n1ccccc1CN", "N=CC1=NCC=CC1",
				"N=CC1=NC=CCC1", "n1ccccc1CN", "N=CC1=NCCC=C1",
				"N1=CCC=CC1=CN", "N=CC1N=CCC=C1", "N1=CC=CCC1=CN",
	...
	{	
		int res = tt.testCase("COC1=CC(C)=NC(N)=N1", 
				new String[]{"N=1C(OC)=CC(=C)NC=1N", "N=1C(=C)C=C(OC)NC=1N", "N=C1NC(OC)=CC(=C)N1",
				"N=1C(=NC(=C)CC=1OC)N", "N=C1N=C(OC)CC(=C)N1", "N=C1N=C(C=C(OC)N1)C",
				"Cc1cc(OC)nc(N)n1", "N=C1N=C(OC)C=C(N1)C", "N=C1N=C(OC)CC(=N1)C",
		"Cc1cc(OC)nc(N)n1"}, 
		FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("NC1=C(O)C=CC=N1", 
				new String[]{"Oc1cccnc1N", "N=C1NC=CC=C1(O)", "N=C1N=CC=CC1(O)",
				"O=C1C(=NC=CC1)N", "O=C1C(=N)NC=CC1", "O=C1C=CCN=C1(N)",
				"O=C1C=CCNC1(=N)", "Oc1cccnc1N", "O=C1C=CC=NC1(N)",
				"N=C1N=CCC=C1(O)", "O=C1C(=N)N=CCC1"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("NC1=CC=C(O)C(=C1)C(O)=O", 
	...
	{	
		int res = tt.testCase("COC(=O)C1=CC=C(C(=O)OC)C(N)=C1", 
				new String[]{"Nc1cc(ccc1C(=O)OC)C(=O)OC", "O=C(OC)C1=CC=C(C(=O)OC)CC1(=N)", "O=C(OC)C=1C=CC(C(=N)C=1)=C(O)OC", "Nc1cc(ccc1C(=O)OC)C(=O)OC", "O=C(OC)C=1C=CC(C(=O)OC)C(=N)C=1", "O=C(OC)C1=CCC(=CC1(=N))C(=O)OC"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("NC(=O)C1=C(N)C=CC=C1", 
				new String[]{"N=C1C=CC=CC1=C(O)N", "OC(=N)c1ccccc1N", "N=C(O)C1C=CC=CC1(=N)",
				"O=C(N)c1ccccc1N", "O=C(N)C1C=CC=CC1(=N)", "OC(=N)c1ccccc1N",
				"N=C(O)C1=CCC=CC1(=N)", "O=C(N)c1ccccc1N", "O=C(N)C1=CCC=CC1(=N)",
				"O=C(N)C1=CC=CCC1(=N)", "N=C(O)C1=CC=CCC1(=N)"}, 
				FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("CC(=O)NC1=CC=C(C=O)C=C1", 
	...
	{	
		int res = tt.testCase("COC1=C(OC)C(O)=C(C=O)C(C)=C1", 
	...
	{	
		int res = tt.testCase("NC1=CC(=N)N=C(O)N1", 
				new String[]{"N=C1N=C(O)NC(N)=C1", "N=C1C=C(N=C(O)N1)N", "N=C1N=C(O)NC(=N)C1",
				"Nc1cc(N)nc(O)n1", "N=C1N=C(O)N=C(N)C1", "O=C1NC(=N)C=C(N)N1",
				"O=C1N=C(N)C=C(N)N1", "O=C1N=C(N)CC(=N)N1", "O=C1N=C(N)CC(=N1)N",
		"O=C1NC(=N)CC(=N)N1"}, 
		FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("NC1=NC(=O)NC=C1F", 
				new String[]{"Fc1cnc(O)nc1N", "O=C1N=C(N)C(F)=CN1", "Fc1cnc(O)nc1N",
				"FC1C=NC(O)=NC1(=N)", "O=C1N=CC(F)=C(N)N1", "O=C1N=CC(F)C(=N)N1",
				"O=C1N=CC(F)C(=N1)N", "FC1=CNC(O)=NC1(=N)", "FC1=CN=C(O)NC1(=N)",
		"O=C1NC=C(F)C(=N)N1"}, 
		FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("O=C1CC=NC(=S)N1", 
				new String[]{"O=C1N=C(NC=C1)S", "O=C1C=CN=C(N1)S", "Oc1ccnc(S)n1",
	...
	{	
		int res = tt.testCase("NNC1=NNC(=S)N1N", 
				new String[]{"NNc1nnc(S)n1N", "N(N)=C1NN=C(N1(N))S", "N=NC1NN=C(N1(N))S",
				"N1=NC(N(N)C1=NN)S", "N=NC1=NNC(N1(N))S", "N=NC1N=NC(N1(N))S",
				"N=1NC(N(N)C=1NN)=S", "N(N)=C1NNC(N1(N))=S", "N=NC1NNC(N1(N))=S",
		"N1=NC(NN)N(N)C1=S"}, 
		FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("SC1=NC=C(I)C(=O)N1", 
				new String[]{"Ic1cnc(S)nc1O", "O=C1NC(=NC=C1I)S", "O=C1N=C(NC=C1I)S",
	...
	{	
		int res = tt.testCase("CC(=O)C1=CC=CC(N)=C1", 
				new String[]{"OC(=C)c1cc(N)ccc1", "N=C1C=CC=C(C(O)=C)C1", "O=C(C)c1cc(N)ccc1",
				"O=C(C1=CC=CC(=N)C1)C", "OC(=C)c1cc(N)ccc1", "O=C(C)c1cc(N)ccc1",
	...
	{	
		int res = tt.testCase("CC(=O)C1=CC=C(N)C=C1", 
				new String[]{"N=C1C=CC(C=C1)=C(O)C", "OC(=C)c1ccc(N)cc1", "N=C1C=CC(=CC1)C(O)=C",
				"N=C1C=CC(C=C1)C(O)=C", "O=C(C)c1ccc(N)cc1", "O=C(C=1C=CC(=N)CC=1)C",
		"O=C(C)C1C=CC(=N)C=C1"}, 
		FlagPrintTautomers);
	...
	{	
		int res = tt.testCase("NC1=C2C=CC=CC2=NC2=CC=CC=C12", 
	...
	{	
		int res = tt.testCase("NC1=C2C(=O)C3=C(C=CC=C3)C(=O)C2=CC=C1", 
				new String[]{"OC=3c1ccccc1C(=O)C2=CC=CC(=N)C2=3", "O=C3c1ccccc1C(=O)c2c3cccc2N", "N=C3C=CC=C2C(=O)c1ccccc1C(=O)C23",
	...
	{	
		int res = tt.testCase("NC1=NC2=CC=CC=C2N1", 
				new String[]{"Nc1nc2ccccc2n1", "N1=C(N=C2C1=CC=CC2)N", "N=C1Nc2ccccc2N1",
				"N=C2N=C1C(=CC=CC1)N2", "N=C1Nc2ccccc2N1", "N=C1N=C2C=CC=CC2(N1)",
				"N=C1N=C2C=CCC=C2(N1)", "N=C1N=C2C=CCCC2(=N1)", "N=C1N=C2C(=N1)CC=CC2",
	...
	{	
		int res = tt.testCase("NC1=CC=C2OCCOC2=C1", 
