...
public class ValueLatchPairEditor<T> extends AbstractEditor<ValueLatchPair<T>>{
	...
	public ValueLatchPairEditor(IWorkflowContextFactory wfcfactory) {
		...
		nextButton = new JButton(new AbstractAction("&OK") {
		...
		nextButton.setAlignmentY(Component.RIGHT_ALIGNMENT);
		cancelButton = new JButton(new AbstractAction("&Cancel") {
			public void actionPerformed(ActionEvent e) {
				//this should open the latch
				getObject().getLatch().setValue(null);
				setObject(null);
			}
		});
		cancelButton.setAlignmentY(Component.RIGHT_ALIGNMENT);
		t.add(nextButton);
		t.add(cancelButton);
