...
public class AtomEnvironmentMatrixDescriptor implements IMolecularDescriptor {
    ...
    public DescriptorSpecification getSpecification() {
		...
		return new DescriptorSpecification(
				String.format(Property.AMBIT_DESCRIPTORS_ONTOLOGY,"AtomEnvironmentMatrix"),
     ...
     * @throws CDKException
     */
    public Hashtable<String,Integer> doCalculation(IAtomContainer atomContainer) throws CDKException {
    	Hashtable<String,Integer> sparseMatrix = new Hashtable<String, Integer>();
        if ((atm == null) || (factory == null)) descriptorNames = initAtomTypes(null,null);
    ...
    private String[] initAtomTypes(AtomTypeFactory factory,IAtomTypeMatcher atm) throws CDKException {
