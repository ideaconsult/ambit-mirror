...
public class TestDescriptors {
	...
	public void performDescriptorTest(IMolecularDescriptor descriptor, int descrValueIndex, String info,
		...
		Assert.assertEquals("smiles[] and expectedValues[] arrays must be of equal size()", smiles.size(),
				expectedValues.size());
		...
		for (int i = 0; i < smiles.size(); i++) {
			...
			Assert.assertEquals(info + " value for " + smiles.get(i), expectedValues.get(i).doubleValue(), d,
					eps_precision);
		}
	}
	...
	/*
	 * later public void testRingDescriptors() throws Exception {
	 * ArrayList<String> smiles = new ArrayList<String>();
	 * 
	 * ArrayList<Double> expectedValues1 = new ArrayList<Double> ();
	 * ArrayList<Double> expectedValues2 = new ArrayList<Double> ();
	 ...
	 * 
	 * 
	 * smiles.add("O=C(c1ccc(cc1O)OC)c2ccccc2O"); expectedValues1.add(new
	 * Double(0.667)); expectedValues2.add(new Double(0));
	 * expectedValues3.add(new Double(2)); expectedValues4.add(new Double(1));
	 * expectedValues5.add(new Double(1)); expectedValues6.add(new Double(12));
	 * expectedValues7.add(new Double(12)); expectedValues8.add(new Double(0));
	 * expectedValues9.add(new Double(1));
	 * 
	 * 
	 * smiles.add("OS(=O)(=O)c1cc(c(O)cc1OC)C(=O)c2ccccc2");
	 * expectedValues1.add(new Double(0.571)); expectedValues2.add(new
	 * Double(0)); expectedValues3.add(new Double(2)); expectedValues4.add(new
	 * Double(1)); expectedValues5.add(new Double(1)); expectedValues6.add(new
	 * Double(12)); expectedValues7.add(new Double(12)); expectedValues8.add(new
	 * Double(0)); expectedValues9.add(new Double(1));
	 * 
	 * smiles.add("O=C(c1ccc(cc1O)OC)c2ccccc2"); expectedValues1.add(new
	 * Double(0.706)); expectedValues2.add(new Double(0));
	 * expectedValues3.add(new Double(2)); expectedValues4.add(new Double(1));
	 * expectedValues5.add(new Double(1)); expectedValues6.add(new Double(12));
	 * expectedValues7.add(new Double(12)); expectedValues8.add(new Double(0));
	 * expectedValues9.add(new Double(1));
	 * 
	 * smiles.add("OC1C(O)C(O)C(=O)OC1CO"); expectedValues1.add(new
	 * Double(0.500)); expectedValues2.add(new Double(0));
	 * expectedValues3.add(new Double(1)); expectedValues4.add(new Double(1));
	 * expectedValues5.add(new Double(1)); expectedValues6.add(new Double(6));
	 * expectedValues7.add(new Double(6)); expectedValues8.add(new Double(0));
	 * expectedValues9.add(new Double(1));
	 * 
	 * smiles.add("COc1ccc(/C=C/C(=O)OCC(CC)CCCC)cc1"); expectedValues1.add(new
	 * Double(0.286)); expectedValues2.add(new Double(0));
	 * expectedValues3.add(new Double(1)); expectedValues4.add(new Double(1));
	 * expectedValues5.add(new Double(1)); expectedValues6.add(new Double(6));
	 * expectedValues7.add(new Double(6)); expectedValues8.add(new Double(0));
	 * expectedValues9.add(new Double(1));
	 ...
	 * 
	 * 
	 * performDescriptorTest(descriptor, 0, "RingDescriptors", smiles,
	 * expectedValues1, 1.0e-3); performDescriptorTest(descriptor, 1,
	 * "RingDescriptors", smiles, expectedValues2, 1.0e-2);
	 * performDescriptorTest(descriptor, 2, "RingDescriptors", smiles,
	 * expectedValues3, 1.0e-2); performDescriptorTest(descriptor, 3,
	 * "RingDescriptors", smiles, expectedValues4, 1.0e-2);
	 * performDescriptorTest(descriptor, 4, "RingDescriptors", smiles,
	 * expectedValues5, 1.0e-3); performDescriptorTest(descriptor, 5,
	 * "RingDescriptors", smiles, expectedValues6, 1.0e-2);
	 * performDescriptorTest(descriptor, 6, "RingDescriptors", smiles,
	 * expectedValues7, 1.0e-2); performDescriptorTest(descriptor, 7,
	 * "RingDescriptors", smiles, expectedValues8, 1.0e-2);
	 * performDescriptorTest(descriptor, 8, "RingDescriptors", smiles,
	 * expectedValues9, 1.0e-2);
	 * 
	 * }
	 * 
	 * 
	 * public void testNonHAtomNumber() throws Exception { ArrayList<String>
	 * smiles = new ArrayList<String>(); ArrayList<Double> expectedValues = new
	 * ArrayList<Double> ();
	 * 
	 * IMolecularDescriptor descriptor = new NonHAtomNumber();
	 * 
	 * smiles.add("[H][H]"); expectedValues.add(new Double(0));
	 * 
	 * smiles.add("C[CH2]"); expectedValues.add(new Double(2));
	 * 
	 * smiles.add("C(Cl)C[CH2]"); expectedValues.add(new Double(4));
	 * 
	 * smiles.add("ClCCB"); expectedValues.add(new Double(4));
	 * 
	 * smiles.add("CC(Br)C(Cl)CC(O)CNO"); expectedValues.add(new Double(11));
	 * 
	 * 
	 * performDescriptorTest(descriptor, 0, "NonHAtomNumber", smiles,
	 * expectedValues, 1.0e-0);
	 * 
	 * }
	 * 
	 * public void testBondNumber() throws Exception { ArrayList<String> smiles
	 * = new ArrayList<String>(); ArrayList<Double> expectedValues1 = new
	 * ArrayList<Double> (); ArrayList<Double> expectedValues2 = new
	 * ArrayList<Double> ();
	 * 
	 * IMolecularDescriptor descriptor = new BondNumber();
	 * 
	 * smiles.add("[H][H]"); expectedValues1.add(new Double(1));
	 * expectedValues2.add(new Double(0));
	 * 
	 * 
	 * smiles.add("C[CH2]"); expectedValues1.add(new Double(6));
	 * expectedValues2.add(new Double(1));
	 * 
	 * 
	 * smiles.add("CC(C)=CC(=O)CC(C)CC=O"); expectedValues1.add(new Double(27));
	 * expectedValues2.add(new Double(11));
	 * 
	 * smiles.add("C(Cl)C[CH2]"); expectedValues1.add(new Double(9));
	 * expectedValues2.add(new Double(3));
	 * 
	 * smiles.add("C(O)C(=O)Br"); expectedValues1.add(new Double(7));
	 * expectedValues2.add(new Double(4));
	 * 
	 * 
	 * smiles.add("CC(Br)C(Cl)CC(O)CNO"); expectedValues1.add(new Double(23));
	 * expectedValues2.add(new Double(10));
	 * 
	 * 
	 * performDescriptorTest(descriptor, 0, "BondNumber", smiles,
	 * expectedValues1, 1.0e-2); performDescriptorTest(descriptor, 1,
	 * "BondNumber", smiles, expectedValues2, 1.0e-2);
	 * 
	 * 
	 * }
	 * 
	...
	@Test
	public void testMolSig() throws Exception {
		SmilesParser p = new SmilesParser(SilentChemObjectBuilder.getInstance());
		String[] smiles = new String[] { "C[C@H](C(=O)O)O", "C[C@@H](C(=O)O)O" };
		for (String smi : smiles) {
			...
			System.out.println(sig.getGraphSignature());
			System.out.println(sig.reconstructCanonicalEdgeString());
			for (String s : sig.getVertexSignatureStrings())
