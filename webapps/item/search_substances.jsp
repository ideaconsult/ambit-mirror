...
<c:set	var="checked_fp" value=""/>
	<c:set	var="checked_substructure" value=""/>
...
<c:if test="${!empty sessionScope.search_similarity}" >
		<c:choose>
			...
			<c:when test="${sessionScope.search_similarity eq 'substructure'}" >
				<c:set	var="checked_exact" value=""/>
				<c:set	var="checked_fp" value=""/>
				<c:set	var="checked_substructure" value="checked"/>
			</c:when>
		</c:choose>
</c:if>
...
<input type="radio" name="similarity" value="substructure" ${checked_substructure}>Substructure
