...
$(document).ready(function() {
	$( "#tabs" ).tabs();	
	var oTable = defineFacetAssayTemplates("${ambit_root}","${ambit_request_json}","#facet");

	jQuery("#breadCrumb ul").append('<li><a href="${ambit_root}/assaytemplates" title="Templates">Templates</a></li>');
...
<ul>
<li><a href="#tabs_substance" id="header_substance">Assay templates</a></li>
