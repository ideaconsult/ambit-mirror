...
My account pages lets you to modify account details, change password, manage access tokens <a href='#' class='chelp htokens'>?</a>
...
<div id="keys" style="display:none;">
  <ul>
    ...
    <li><a href="#htokens">Access tokens</a></li>
  ...
  <div id="htokens">
    <p>
    For managing Application programming Interface (API) tokens, click <a href='${ambit_root}/myaccount/apps'>here</a>
    </p>
  </div>    
