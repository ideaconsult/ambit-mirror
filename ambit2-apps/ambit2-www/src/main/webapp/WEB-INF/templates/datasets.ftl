...
<script type='text/javascript'>
	...
	$(document).ready(function() {
		$( "#tabs" ).tabs();
		$("#_searchdiv").html("<form class='remove-bottom' action='${ambit_root}/dataset'><b>Dataset name</b> <input name='search' class='search' value='' id='search' title='Feature search'> <input type='submit' value='Search'></form>");
	...
	<div id="tabs_dataset" >
		...
		<div class="row" style="padding:0;" >			
			...
			<div class='row half-bottom' style='margin:5px;padding:5px;'>
				<label class='five columns alpha'>Dataset at </label>
				<span class='eleven columns alpha half-bottom' >
					<a href='${ambit_root}/dataset/${datasetid}'>${ambit_root}/dataset/${datasetid}</a>
				</span>
			</div>			
