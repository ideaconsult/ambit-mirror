...
<link rel="stylesheet" href='${ambit_root}/scripts/toxtree/ui-prediction.css'/>
...
<script type='text/javascript' src='${ambit_root}/scripts/toxtree/ui-prediction.js'></script>
...
<div class="remove-bottom h5"  style="padding-top:0px">
  ...
  <div class="jtox-toolkit" 
	...
	data-configuration="config_model" 
    ...
    <div id="tt-algorithm" class="tt-algorithm jtox-foldable folded">
      <div class="title" >
        ...
        <div class="jtox-inline command-buttons">
          <button class="jt-toggle jtox-handler predict" data-handler="runPredict" title="Run prediction with the algorithm on current compound">▶</button>
