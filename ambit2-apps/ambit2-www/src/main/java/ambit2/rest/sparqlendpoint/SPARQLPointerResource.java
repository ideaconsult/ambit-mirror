...
public class SPARQLPointerResource extends CatalogResource<String> {
	...
	@Override
	public IProcessor<Iterator<String>, Representation> createConvertor(Variant variant)
	...
	public static synchronized String getOntologyServiceURI() {
		AMBITAppConfigProperties properties = new AMBITAppConfigProperties();
		return properties.getOntologyService();
	}
}
