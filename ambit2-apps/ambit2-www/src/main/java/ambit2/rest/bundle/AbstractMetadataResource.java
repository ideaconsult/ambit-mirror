...
abstract public class AbstractMetadataResource<M extends ISourceDataset>
	...
	protected void doInit() throws ResourceException {
		...
		customizeVariants(new MediaType[] { MediaType.TEXT_HTML,
				MediaType.TEXT_URI_LIST, ChemicalMediaType.CHEMICAL_SMILES,
				ChemicalMediaType.CHEMICAL_CML,
				ChemicalMediaType.CHEMICAL_MDLSDF,
				ChemicalMediaType.CHEMICAL_MDLMOL, ChemicalMediaType.WEKA_ARFF,
	...
	public RepresentationConvertor createConvertor(Variant variant)
		...
		if (variant.getMediaType().equals(MediaType.APPLICATION_JSON)) {
			return new OutputWriterConvertor(
					new MetadatasetJSONReporter<IQueryRetrieval<M>, M>(
							getRequest()), MediaType.APPLICATION_JSON);
		} else if (variant.getMediaType().equals(MediaType.TEXT_URI_LIST)) {
			return new StringConvertor(
					new DatasetURIReporter<IQueryRetrieval<M>, M>(getRequest()),
			...
			return new RDFJenaConvertor<ISourceDataset, IQueryRetrieval<ISourceDataset>>(
					new MetadataRDFReporter<ISourceDataset, IQueryRetrieval<ISourceDataset>>(
	...
	@Override
	protected QueryURIReporter<M, IQueryRetrieval<M>> getURUReporter(
	...
	protected Representation put(Representation entity, Variant variant)
		...
		if (getRequest().getAttributes().get(
				DatasetStructuresResource.datasetKey) != null)
	...
	@Override
	public void executeUpdate(Representation entity, M entry,
