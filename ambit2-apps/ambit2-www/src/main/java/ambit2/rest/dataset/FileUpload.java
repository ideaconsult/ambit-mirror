...
public class FileUpload<USERID> {
	...
	public Representation upload(Representation entity, 
		...
		if (MediaType.APPLICATION_WWW_FORM.equals(entity.getMediaType())) {
			boolean clearPreviousContent = !propertyOnly; //propertyOnly  POST: false, PUT : true 
			return copyDatasetToQueryResultsTable(new Form(entity),token,clearPreviousContent);
	          ...
	          try {
	              ...
	              DatasetURIReporter<IQueryRetrieval<ISourceDataset>,ISourceDataset> reporter = 
	            	  	new DatasetURIReporter<IQueryRetrieval<ISourceDataset>,ISourceDataset> (getRequest(),null);
