...
public abstract class QueryHTMLReporter<T, Q extends IQueryRetrieval<T>> extends QueryReporter<T, Q, Writer> {
    ...
    public QueryHTMLReporter(Request request, DisplayMode _dmode) {
	this(request, _dmode, false);
    }

    public QueryHTMLReporter(Request request, DisplayMode _dmode,  boolean headless) {
	super();
