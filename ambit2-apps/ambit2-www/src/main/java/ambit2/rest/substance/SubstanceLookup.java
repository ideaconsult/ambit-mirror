...
public class SubstanceLookup<Q extends IQueryRetrieval<SubstanceRecord>,T extends SubstanceRecord> extends SubstanceResource<Q,T> { 
	protected enum _query_type  {related,reference,facet,study};
	protected enum _query_subtype  {protocol,experiment,owner};
	protected enum _query_protocol_application  {uuid,name,externalid,studyResultType,topcategory,reliability,purposeFlag,isRobustStudy};
	...
	protected Q createQuery(Context context, Request request, Response response) throws ResourceException {
		...
		case study: {
			...
			case protocol: {
				/**
				 * search by study 
				 * /query/substance/study/protocol/citation
			...
			case owner: {
				/**
				 * search by owner 
				 * /query/substance/study/owner/name
