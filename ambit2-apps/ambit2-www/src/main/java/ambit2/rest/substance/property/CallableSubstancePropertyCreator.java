...
public class CallableSubstancePropertyCreator<USERID> extends CallableProtectedTask<USERID> {
	 ...
	 */
	public CallableSubstancePropertyCreator(PropertyURIReporter reporter, Method method, File file, MediaType mediaType,
			Property item, USERID token) throws ResourceException {
		super(token);
		this.reporter = reporter;
		this.file = file;
	...
	public TaskResult doCall() throws Exception {
		if (file != null) {
			// TODO RDF iterator ignores property annotations, which will affect
			// the URI generated
