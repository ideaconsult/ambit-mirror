...
public class AlgorithmResourceTest extends ResourceTest {
	...
	headers.add("dataset_uri", String.format("http://localhost:%d/dataset/1", port));
	Reference ref = testAsyncTask(String.format(
		"http://localhost:%d/algorithm/ambit2.dragon.DescriptorDragonShell/MW", port), headers,
	...
	headers.add("dataset_uri", String.format("http://localhost:%d/dataset/1", port));
	Reference ref = testAsyncTask(model.toString(), headers, Status.SUCCESS_OK, String.format(
		"http://localhost:%d/dataset/%s", port,
		"1?feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Fmodel%2F3%2Fpredicted"));
	// "1?feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Ffeature%2FXLogPorg.openscience.cdk.qsar.descriptors.molecular.XLogPDescriptor"));
	...
	headers.add("mopac_commands", "PM6 NOINTER MMOK BONDS MULLIK GNORM=1.0 T=30.00M");
	Reference ref = testAsyncTask(String.format(
		"http://localhost:%d/algorithm/ambit2.mopac.MopacOriginalStructure", port), headers, Status.SUCCESS_OK,
	...
	Assert.assertTrue(task.getResult().toExternalForm()
		.startsWith(String.format("http://localhost:%d/compound/", port)));
	...
	String expected = String.format("http://localhost:%d/query/relation/compound/HAS_TAUTOMER?dataset_uri=%s",
	...
	// headers.add("dataset_uri",String.format("http://localhost:%d/dataset/1",
	// port));
	testAsyncTask(String.format("http://localhost:%d/algorithm/structurequality", port), headers,
		Status.SUCCESS_OK, "");
	// "1?feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Fmodel%2FBCUT%2Bdescriptors%2Fpredicted"));
	...
	Form headers = new Form();
	headers.add("dataset_uri", String.format("http://localhost:%d/dataset/1", port));
	testAsyncTask(String.format("http://localhost:%d/algorithm/ambit2.descriptors.InChI", port), headers,
		Status.SUCCESS_OK, String.format("http://localhost:%d/dataset/%s", port,
			"1?feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Fmodel%2F3%2Fpredicted"
	...
	Form headers = new Form();
	headers.add("dataset_uri", String.format("http://localhost:%d/dataset/1", port));
	testAsyncTask(String.format("http://localhost:%d/algorithm/ambit2.some.DescriptorSOMEShell", port), headers,
		Status.SUCCESS_OK, String.format("http://localhost:%d/dataset/%s", port,
			"1?feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Fmodel%2F3%2Fpredicted"
		// "1?feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Ffeature%2FBCUTw-1lorg.openscience.cdk.qsar.descriptors.molecular.BCUTDescriptor&feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Ffeature%2FBCUTw-1horg.openscience.cdk.qsar.descriptors.molecular.BCUTDescriptor&feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Ffeature%2FBCUTc-1lorg.openscience.cdk.qsar.descriptors.molecular.BCUTDescriptor&feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Ffeature%2FBCUTc-1horg.openscience.cdk.qsar.descriptors.molecular.BCUTDescriptor&feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Ffeature%2FBCUTp-1lorg.openscience.cdk.qsar.descriptors.molecular.BCUTDescriptor&feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Ffeature%2FBCUTp-1horg.openscience.cdk.qsar.descriptors.molecular.BCUTDescriptor"
			));
	...
	testAsyncTask(
		String.format(
			"http://localhost:%d/algorithm/org.openscience.cdk.qsar.descriptors.molecular.IPMolecularLearningDescriptor",
			port), headers, Status.SUCCESS_OK, String.format("http://localhost:%d/dataset/%s", port,
			"1?feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Fmodel%2F3%2Fpredicted"
		// "1?feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Ffeature%2FBCUTw-1lorg.openscience.cdk.qsar.descriptors.molecular.BCUTDescriptor&feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Ffeature%2FBCUTw-1horg.openscience.cdk.qsar.descriptors.molecular.BCUTDescriptor&feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Ffeature%2FBCUTc-1lorg.openscience.cdk.qsar.descriptors.molecular.BCUTDescriptor&feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Ffeature%2FBCUTc-1horg.openscience.cdk.qsar.descriptors.molecular.BCUTDescriptor&feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Ffeature%2FBCUTp-1lorg.openscience.cdk.qsar.descriptors.molecular.BCUTDescriptor&feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Ffeature%2FBCUTp-1horg.openscience.cdk.qsar.descriptors.molecular.BCUTDescriptor"
			));
	// "1?feature_uris[]=http%3A%2F%2Flocalhost%3A8181%2Fmodel%2FBCUT%2Bdescriptors%2Fpredicted"));
    ...
    /*
     * @Test public void testSMSD() throws Exception { Form headers = new
     * Form(); headers.add(OpenTox.params.dataset_uri.toString(),
     * String.format("http://localhost:%d/dataset/1", port)); testAsyncTask(
     * String.format("http://localhost:%d/algorithm/mcss", port), headers,
     * Status.SUCCESS_OK, String.format("http://localhost:%d/model/%s",
     * port,"3")); //prediction
     * 
     * 
     * IDatabaseConnection c = getConnection(); ITable table =
     * c.createQueryTable
     * ("EXPECTED","SELECT * from properties where name='CC'");
     * Assert.assertEquals(1,table.getRowCount()); table =
     * c.createQueryTable("EXPECTED",
     * "SELECT * from properties join property_values using(idproperty) join catalog_references using(idreference) where name='CC' and type='Model'"
     * ); Assert.assertEquals(2,table.getRowCount()); c.close();
     * 
     * }
     */
	...
	Form headers = new Form();
	Reference dataset = new Reference(
	...
	ITable table = c.createQueryTable("EXPECTED", "SELECT * from properties where name='caco2'");
	Assert.assertEquals(2, table.getRowCount());

	ClientResourceWrapper client = new ClientResourceWrapper(new Reference(String.format(
		"http://localhost:%d/model/3", port)));
	...
	Form headers = new Form();
	Reference model = testAsyncTask(String.format("http://localhost:%d/algorithm/pka", port), headers,
		Status.SUCCESS_OK, String.format("http://localhost:%d/model/%s", port, "3"));
	...
	Assert.assertEquals(1, count);
	headers = new Form();
	headers.add(OpenTox.params.dataset_uri.toString(), ref.toString());
	Reference clusterModel = testAsyncTask(String.format("http://localhost:%d/algorithm/SimpleKMeans", port),
		headers, Status.SUCCESS_OK, String.format("http://localhost:%d/model/%s", port, "4"));

	Reference clusteredResults = testAsyncTask(
		clusterModel.toString(),
		headers,
		Status.SUCCESS_OK,
	...
	Form headers = new Form();
	headers.add(OpenTox.params.dataset_uri.toString(), String.format("http://localhost:%d/dataset/1", port));
	testAsyncTask(String.format("http://localhost:%d/algorithm/pcaRanges", port), headers, Status.SUCCESS_OK,
	...
	testAsyncTask(String.format("http://localhost:%d/algorithm/distanceEuclidean", port), headers,
		Status.SUCCESS_OK, String.format("http://localhost:%d/model/%s", port, "3"));
	...
	Form headers = new Form();
	headers.add(OpenTox.params.dataset_uri.toString(), String.format("http://localhost:%d/dataset/1", port));
	testAsyncTask(String.format("http://localhost:%d/algorithm/distanceCityBlock", port), headers,
		Status.SUCCESS_OK, String.format("http://localhost:%d/model/%s", port, "3"));
	...
	Form headers = new Form();
	headers.add(OpenTox.params.dataset_uri.toString(), String.format("http://localhost:%d/dataset/1", port));
	testAsyncTask(String.format("http://localhost:%d/algorithm/distanceMahalanobis", port), headers,
		Status.SUCCESS_OK, String.format("http://localhost:%d/model/%s", port, "3"));
	...
	testAsyncTask(String.format("http://localhost:%d/algorithm/fptanimoto", port), headers, Status.SUCCESS_OK,
		String.format("http://localhost:%d/model/%s", port, "3"));
	...
	Form headers = new Form();
	headers.add(OpenTox.params.dataset_uri.toString(), String.format("http://localhost:%d/dataset/1", port));
	testAsyncTask(String.format("http://localhost:%d/algorithm/nparamdensity", port), headers, Status.SUCCESS_OK,
		String.format("http://localhost:%d/model/%s", port, "3"));
	...
	Form headers = new Form();
	headers.add(OpenTox.params.dataset_uri.toString(), String.format("http://localhost:%d/dataset/1", port));
	testAsyncTask(String.format("http://localhost:%d/algorithm/PCA", port), headers, Status.SUCCESS_OK,
		String.format("http://localhost:%d/model/%s", port, "3"));
	...
	RemoteTask taskTrain = new RemoteTask(new Reference("http://localhost:8080/algorithm/leverage"),
	...
	RemoteTask taskEstimate = new RemoteTask(taskTrain.getResult(), MediaType.APPLICATION_WWW_FORM,
	...
	/*
	 * I ran a short test and > > it seems to be the case, yes. > > curl -X
	 * POST -d > >
	 * "dataset_uri=http://ambit.uni-plovdiv.bg:8080/ambit2/dataset/157" -d
	 * > > "ALL=false" -d "GravitationalIndexDescriptor=true" > >
	 * http://opentox
	 * .informatik.tu-muenchen.de:8080/OpenTox-dev/algorithm/CDKPhysChem > >
	 * > > curl -X POST -d > >
	 ...
	 * .informatik.tu-muenchen.de:8080/OpenTox-dev/algorithm/CDKPhysChem > >
	 * > > result e.g.: > >
	 * http://ambit.uni-plovdiv.bg:8080/ambit2/feature/83436 > > for both
	 * datasets
	 */
	...
	for (int i = 0; i < 2; i++) {
	    ...
	    Reference model = testAsyncTask(String.format("http://localhost:%d/algorithm/toxtreecramer", port),
		    headers, Status.SUCCESS_OK, String.format("http://localhost:%d/model/%s", port, "1"));
	    // for some reason models table has autoincrement=4
	    OTModel otmodel = OTModel.model(model.toString());
	    OTDataset dataset = otmodel.predict(OTDataset.dataset(String.format("http://localhost:%d/dataset/%s", port,
		    "1")));
	...
	testAsyncTask(String.format("http://localhost:%d/algorithm/toxtreeskinsens", port), headers, Status.SUCCESS_OK,
		String.format("http://localhost:%d/model/%s", port, "3"));
	...
	testAsyncTask(String.format("http://localhost:%d/algorithm/toxtreednabinding", port), headers,
		Status.SUCCESS_OK, String.format("http://localhost:%d/model/%s", port, "3"));
	...
	testAsyncTask(String.format("http://localhost:%d/algorithm/toxtreeproteinbinding", port), headers,
		Status.SUCCESS_OK, String.format("http://localhost:%d/model/%s", port, "3"));
	...
	testAsyncTask(String.format("http://localhost:%d/algorithm/toxtreecarc", port), headers, Status.SUCCESS_OK,
		String.format("http://localhost:%d/model/%s", port, "3"));
	...
	testAsyncTask(String.format("http://localhost:%d/algorithm/toxtreeames", port), headers, Status.SUCCESS_OK,
		String.format("http://localhost:%d/model/%s", port, "3"));
	...
	testAsyncTask(String.format("http://localhost:%d/algorithm/toxtreesmartcyp", port), headers, Status.SUCCESS_OK,
		String.format("http://localhost:%d/model/%s", port, "3"));
	...
	testAsyncTask(String.format("http://localhost:%d/algorithm/toxtreeverhaar", port), headers, Status.SUCCESS_OK,
		String.format("http://localhost:%d/model/%s", port, "3"));
	...
	testAsyncTask(String.format("http://localhost:%d/algorithm/toxtreeskinirritation", port), headers,
		Status.SUCCESS_OK, String.format("http://localhost:%d/model/%s", port, "3"));
