	...
	public enum METHODS {
		all {
			...
			public String[] getOpenToxEntry() {
				return new String[] {Property.opentox_CAS,Property.opentox_Name,Property.opentox_SMILES,Property.opentox_InChI,Property.opentox_InChIKey};
			}			
		},
		smiles {
			@Override
		...
		names {
			@Override
			public String[] getOpenToxEntry() {
				return new String[] {Property.opentox_IupacName, Property.opentox_Name};
			}
		},
		image,
		ficus,
